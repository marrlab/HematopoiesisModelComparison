...
%HSC
xdot(1) =-(b_HSC*4+a_HSC_MPP*4+a_HSC_mat*4+g_HSC*4)*x1;
...
xdot(10) =a_HSC_mat*4*(x1-x10);
xdot(11) =a_HSC_mat*4*(x10-x11);
xdot(12) =a_HSC_mat*4*(x11-x12);
xdot(13) =a_HSC_mat*4*(x12-x13);
xdot(14) =g_HSC*4*(x1-x14);
xdot(15) =g_HSC*4*(x14-x15);
xdot(16) =g_HSC*4*(x15-x16);
xdot(17) =g_HSC*4*(x16-x17);
xdot(18) =+2*b_HSC*4*x5-(b_HSC*4+a_HSC_MPP*4+a_HSC_mat*4+g_HSC*4)*x18;
...
xdot(27) =a_HSC_mat*4*(x18-x27);
xdot(28) =a_HSC_mat*4*(x27-x28);
xdot(29) =a_HSC_mat*4*(x28-x29);
xdot(30) =a_HSC_mat*4*(x29-x30);
xdot(31) =g_HSC*4*(x18-x31);
xdot(32) =g_HSC*4*(x31-x32);
xdot(33) =g_HSC*4*(x32-x33);
xdot(34) =g_HSC*4*(x33-x34);
xdot(35) =+2*b_HSC*4*x22-(b_HSC*4+a_HSC_MPP*4+a_HSC_mat*4+g_HSC*4)*x35;
...
xdot(44) =a_HSC_mat*4*(x35-x44);
xdot(45) =a_HSC_mat*4*(x44-x45);
xdot(46) =a_HSC_mat*4*(x45-x46);
xdot(47) =a_HSC_mat*4*(x46-x47);
xdot(48) =g_HSC*4*(x35-x48);
xdot(49) =g_HSC*4*(x48-x49);
xdot(50) =g_HSC*4*(x49-x50);
xdot(51) =g_HSC*4*(x50-x51);
xdot(52) =+2*b_HSC*4*x39-(b_HSC*4+a_HSC_MPP*4+a_HSC_mat*4+g_HSC*4)*x52;
...
xdot(61) =a_HSC_mat*4*(x52-x61);
xdot(62) =a_HSC_mat*4*(x61-x62);
xdot(63) =a_HSC_mat*4*(x62-x63);
xdot(64) =a_HSC_mat*4*(x63-x64);
xdot(65) =g_HSC*4*(x52-x65);
xdot(66) =g_HSC*4*(x65-x66);
xdot(67) =g_HSC*4*(x66-x67);
xdot(68) =g_HSC*4*(x67-x68);
xdot(69) =+2*b_HSC*4*x56-(b_HSC*4+a_HSC_MPP*4+a_HSC_mat*4+g_HSC*4)*x69;
...
xdot(78) =a_HSC_mat*4*(x69-x78);
xdot(79) =a_HSC_mat*4*(x78-x79);
xdot(80) =a_HSC_mat*4*(x79-x80);
xdot(81) =a_HSC_mat*4*(x80-x81);
xdot(82) =g_HSC*4*(x69-x82);
xdot(83) =g_HSC*4*(x82-x83);
xdot(84) =g_HSC*4*(x83-x84);
xdot(85) =g_HSC*4*(x84-x85);
xdot(86) =+2*b_HSC*4*x73-(b_HSC*4+a_HSC_MPP*4+a_HSC_mat*4+g_HSC*4)*x86;
...
xdot(95) =a_HSC_mat*4*(x86-x95);
xdot(96) =a_HSC_mat*4*(x95-x96);
xdot(97) =a_HSC_mat*4*(x96-x97);
xdot(98) =a_HSC_mat*4*(x97-x98);
xdot(99) =g_HSC*4*(x86-x99);
xdot(100) =g_HSC*4*(x99-x100);
xdot(101) =g_HSC*4*(x100-x101);
xdot(102) =g_HSC*4*(x101-x102);
xdot(103) =+2*b_HSC*4*x90+2*b_HSC*4*x107-(b_HSC*4+a_HSC_MPP*4+a_HSC_mat*4+g_HSC*4)*x103;
...
xdot(112) =a_HSC_mat*4*(x103-x112);
xdot(113) =a_HSC_mat*4*(x112-x113);
xdot(114) =a_HSC_mat*4*(x113-x114);
xdot(115) =a_HSC_mat*4*(x114-x115);
...
%CMP
xdot(302) =a_MPP_CMP*4*x128-(b_CMP*4+a_CMP_MEP*4+a_CMP_GMP*4+g_CMP*4)*x302;
xdot(303) =+b_CMP*4*(x302-x303);
xdot(304) =+b_CMP*4*(x303-x304);
xdot(305) =+b_CMP*4*(x304-x305);
xdot(306) =+b_CMP*4*(x305-x306);
xdot(307) =a_CMP_MEP*4*(x302-x307);
xdot(308) =a_CMP_MEP*4*(x307-x308);
xdot(309) =a_CMP_MEP*4*(x308-x309);
xdot(310) =a_CMP_MEP*4*(x309-x310);
xdot(311) =a_CMP_GMP*4*(x302-x311);
xdot(312) =a_CMP_GMP*4*(x311-x312);
xdot(313) =a_CMP_GMP*4*(x312-x313);
...
xdot(319) =a_MPP_CMP*4*x145+2*b_CMP*4*x306-(b_CMP*4+a_CMP_MEP*4+a_CMP_GMP*4+g_CMP*4)*x319;
xdot(320) =+b_CMP*4*(x319-x320);
xdot(321) =+b_CMP*4*(x320-x321);
xdot(322) =+b_CMP*4*(x321-x322);
xdot(323) =+b_CMP*4*(x322-x323);
xdot(324) =a_CMP_MEP*4*(x319-x324);
xdot(325) =a_CMP_MEP*4*(x324-x325);
xdot(326) =a_CMP_MEP*4*(x325-x326);
xdot(327) =a_CMP_MEP*4*(x326-x327);
xdot(328) =a_CMP_GMP*4*(x319-x328);
xdot(329) =a_CMP_GMP*4*(x328-x329);
xdot(330) =a_CMP_GMP*4*(x329-x330);
...
xdot(336) =a_MPP_CMP*4*x162+2*b_CMP*4*x323-(b_CMP*4+a_CMP_MEP*4+a_CMP_GMP*4+g_CMP*4)*x336;
xdot(337) =+b_CMP*4*(x336-x337);
xdot(338) =+b_CMP*4*(x337-x338);
xdot(339) =+b_CMP*4*(x338-x339);
xdot(340) =+b_CMP*4*(x339-x340);
xdot(341) =a_CMP_MEP*4*(x336-x341);
xdot(342) =a_CMP_MEP*4*(x341-x342);
xdot(343) =a_CMP_MEP*4*(x342-x343);
xdot(344) =a_CMP_MEP*4*(x343-x344);
xdot(345) =a_CMP_GMP*4*(x336-x345);
xdot(346) =a_CMP_GMP*4*(x345-x346);
...
xdot(353) =a_MPP_CMP*4*x179+2*b_CMP*4*x340-(b_CMP*4+a_CMP_MEP*4+a_CMP_GMP*4+g_CMP*4)*x353;
xdot(354) =+b_CMP*4*(x353-x354);
xdot(355) =+b_CMP*4*(x354-x355);
xdot(356) =+b_CMP*4*(x355-x356);
xdot(357) =+b_CMP*4*(x356-x357);
xdot(358) =a_CMP_MEP*4*(x353-x358);
xdot(359) =a_CMP_MEP*4*(x358-x359);
xdot(360) =a_CMP_MEP*4*(x359-x360);
xdot(361) =a_CMP_MEP*4*(x360-x361);
xdot(362) =a_CMP_GMP*4*(x353-x362);
...
xdot(370) =a_MPP_CMP*4*x196+2*b_CMP*4*x357-(b_CMP*4+a_CMP_MEP*4+a_CMP_GMP*4+g_CMP*4)*x370;
xdot(371) =+b_CMP*4*(x370-x371);
xdot(372) =+b_CMP*4*(x371-x372);
xdot(373) =+b_CMP*4*(x372-x373);
xdot(374) =+b_CMP*4*(x373-x374);
xdot(375) =a_CMP_MEP*4*(x370-x375);
xdot(376) =a_CMP_MEP*4*(x375-x376);
xdot(377) =a_CMP_MEP*4*(x376-x377);
xdot(378) =a_CMP_MEP*4*(x377-x378);
xdot(379) =a_CMP_GMP*4*(x370-x379);
xdot(380) =a_CMP_GMP*4*(x379-x380);
xdot(381) =a_CMP_GMP*4*(x380-x381);
...
xdot(387) =a_MPP_CMP*4*x213+2*b_CMP*4*x374-(b_CMP*4+a_CMP_MEP*4+a_CMP_GMP*4+g_CMP*4)*x387;
xdot(388) =+b_CMP*4*(x387-x388);
xdot(389) =+b_CMP*4*(x388-x389);
xdot(390) =+b_CMP*4*(x389-x390);
xdot(391) =+b_CMP*4*(x390-x391);
xdot(392) =a_CMP_MEP*4*(x387-x392);
xdot(393) =a_CMP_MEP*4*(x392-x393);
xdot(394) =a_CMP_MEP*4*(x393-x394);
xdot(395) =a_CMP_MEP*4*(x394-x395);
xdot(396) =a_CMP_GMP*4*(x387-x396);
xdot(397) =a_CMP_GMP*4*(x396-x397);
xdot(398) =a_CMP_GMP*4*(x397-x398);
xdot(399) =a_CMP_GMP*4*(x398-x399);
xdot(400) =g_CMP*4*(x387-x400);
xdot(401) =g_CMP*4*(x400-x401);
xdot(402) =g_CMP*4*(x401-x402);
xdot(403) =g_CMP*4*(x402-x403);
xdot(404) =a_MPP_CMP*4*x230+2*b_CMP*4*x391+2*b_CMP*4*x408-(b_CMP*4+a_CMP_MEP*4+a_CMP_GMP*4+g_CMP*4)*x404;
xdot(405) =+b_CMP*4*(x404-x405);
xdot(406) =+b_CMP*4*(x405-x406);
xdot(407) =+b_CMP*4*(x406-x407);
xdot(408) =+b_CMP*4*(x407-x408);
xdot(409) =a_CMP_MEP*4*(x404-x409);
xdot(410) =a_CMP_MEP*4*(x409-x410);
xdot(411) =a_CMP_MEP*4*(x410-x411);
xdot(412) =a_CMP_MEP*4*(x411-x412);
xdot(413) =a_CMP_GMP*4*(x404-x413);
...
%GMP
xdot(421) =a_CMP_GMP*4*x314-(b_GMP*4+a_GMP_mat*4+g_GMP*4)*x421;
...
xdot(434) =a_CMP_GMP*4*x331+2*b_GMP*4*x425-(b_GMP*4+a_GMP_mat*4+g_GMP*4)*x434;
...
xdot(447) =a_CMP_GMP*4*x348+2*b_GMP*4*x438-(b_GMP*4+a_GMP_mat*4+g_GMP*4)*x447;
...
xdot(460) =a_CMP_GMP*4*x365+2*b_GMP*4*x451-(b_GMP*4+a_GMP_mat*4+g_GMP*4)*x460;
...
xdot(473) =a_CMP_GMP*4*x382+2*b_GMP*4*x464-(b_GMP*4+a_GMP_mat*4+g_GMP*4)*x473;
...
xdot(486) =a_CMP_GMP*4*x399+2*b_GMP*4*x477-(b_GMP*4+a_GMP_mat*4+g_GMP*4)*x486;
...
xdot(499) =a_CMP_GMP*4*x416+2*b_GMP*4*x490+2*b_GMP*4*x503-(b_GMP*4+a_GMP_mat*4+g_GMP*4)*x499;
...
%MEP
xdot(512) =a_CMP_MEP*4*x310-(b_MEP*4+a_MEP_mat*4+g_MEP*4)*x512;
...
xdot(525) =a_CMP_MEP*4*x327+2*b_MEP*4*x516-(b_MEP*4+a_MEP_mat*4+g_MEP*4)*x525;
...
xdot(538) =a_CMP_MEP*4*x344+2*b_MEP*4*x529-(b_MEP*4+a_MEP_mat*4+g_MEP*4)*x538;
...
xdot(551) =a_CMP_MEP*4*x361+2*b_MEP*4*x542-(b_MEP*4+a_MEP_mat*4+g_MEP*4)*x551;
...
xdot(564) =a_CMP_MEP*4*x378+2*b_MEP*4*x555-(b_MEP*4+a_MEP_mat*4+g_MEP*4)*x564;
...
xdot(577) =a_CMP_MEP*4*x395+2*b_MEP*4*x568-(b_MEP*4+a_MEP_mat*4+g_MEP*4)*x577;
...
xdot(590) =a_CMP_MEP*4*x412+2*b_MEP*4*x581+2*b_MEP*4*x594-(b_MEP*4+a_MEP_mat*4+g_MEP*4)*x590;
...
%mat
xdot(603) =a_HSC_mat*4*x13+a_MEP_mat*4*x520+a_GMP_mat*4*x429-(b_mat*4+g_mat*4)*x603;
...
xdot(612) =a_HSC_mat*4*x30+a_MEP_mat*4*x533+a_GMP_mat*4*x442+2*b_mat*4*x607-(b_mat*4+g_mat*4)*x612;
...
xdot(621) =a_HSC_mat*4*x47+a_MEP_mat*4*x546+a_GMP_mat*4*x455+2*b_mat*4*x616-(b_mat*4+g_mat*4)*x621;
...
xdot(630) =a_HSC_mat*4*x64+a_MEP_mat*4*x559+a_GMP_mat*4*x468+2*b_mat*4*x625-(b_mat*4+g_mat*4)*x630;
...
xdot(639) =a_HSC_mat*4*x81+a_MEP_mat*4*x572+a_GMP_mat*4*x481+2*b_mat*4*x634-(b_mat*4+g_mat*4)*x639;
...
xdot(648) =a_HSC_mat*4*x98+a_MEP_mat*4*x585+a_GMP_mat*4*x494+2*b_mat*4*x643-(b_mat*4+g_mat*4)*x648;
...
xdot(657) =a_HSC_mat*4*x115+a_MEP_mat*4*x598+a_GMP_mat*4*x507+2*b_mat*4*x652+2*b_mat*4*x661-(b_mat*4+g_mat*4)*x657;
...
% INITIAL CONDITIONS
x0 = sym(zeros(size(x)));
x0([1,120,239,302,421,512,603])=exp(p(1:7))-1;
