% simulate_model_J_3.m is the matlab interface to the cvodes mex
...
% USAGE:
% ======
% [...] = simulate_model_J_3(tout,theta)
% [...] = simulate_model_J_3(tout,theta,kappa,data,options)
% [status,tout,x,y,sx,sy] = simulate_model_J_3(...)
%
% INPUTS:
% =======
...
function varargout = simulate_model_J_3(varargin)
...
sol = ami_model_J_3(tout,theta(1:34),kappa(1:0),options_ami,plist,xscale,init,data);
if(nargout>1)
