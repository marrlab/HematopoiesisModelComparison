...
%GMP
xdot(29) = a_MLP_GMP*x15+a_CMP_GMP*x22-(b_GMP+a_GMP_mat+g_GMP)*x29;
xdot(30) = 2*b_GMP*x29++a_MLP_GMP*x16++a_CMP_GMP*x16+-(b_GMP+a_GMP_mat+g_GMP)*x30;
xdot(31) = 2*b_GMP*x30++a_MLP_GMP*x17++a_CMP_GMP*x17+-(b_GMP+a_GMP_mat+g_GMP)*x31;
xdot(32) = 2*b_GMP*x31++a_MLP_GMP*x18++a_CMP_GMP*x18+-(b_GMP+a_GMP_mat+g_GMP)*x32;
xdot(33) = 2*b_GMP*x32++a_MLP_GMP*x19++a_CMP_GMP*x19+-(b_GMP+a_GMP_mat+g_GMP)*x33;
xdot(34) = 2*b_GMP*x33++a_MLP_GMP*x20++a_CMP_GMP*x20+-(b_GMP+a_GMP_mat+g_GMP)*x34;
xdot(35) = 2*b_GMP*x34++a_MLP_GMP*x21++a_CMP_GMP*x21++2*b_GMP*x35-(b_GMP+a_GMP_mat+g_GMP)*x35;
