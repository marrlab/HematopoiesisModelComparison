...
%HSC
xdot(1) =-(b_HSC*3+a_HSC_MEP*3+a_HSC_MPP*3+g_HSC*3)*x1;
xdot(2) =+b_HSC*3*(x1-x2);
xdot(3) =+b_HSC*3*(x2-x3);
xdot(4) =+b_HSC*3*(x3-x4);
xdot(5) =a_HSC_MEP*3*(x1-x5);
xdot(6) =a_HSC_MEP*3*(x5-x6);
xdot(7) =a_HSC_MEP*3*(x6-x7);
...
xdot(14) =+2*b_HSC*3*x4-(b_HSC*3+a_HSC_MEP*3+a_HSC_MPP*3+g_HSC*3)*x14;
xdot(15) =+b_HSC*3*(x14-x15);
xdot(16) =+b_HSC*3*(x15-x16);
xdot(17) =+b_HSC*3*(x16-x17);
xdot(18) =a_HSC_MEP*3*(x14-x18);
xdot(19) =a_HSC_MEP*3*(x18-x19);
xdot(20) =a_HSC_MEP*3*(x19-x20);
...
xdot(27) =+2*b_HSC*3*x17-(b_HSC*3+a_HSC_MEP*3+a_HSC_MPP*3+g_HSC*3)*x27;
xdot(28) =+b_HSC*3*(x27-x28);
xdot(29) =+b_HSC*3*(x28-x29);
xdot(30) =+b_HSC*3*(x29-x30);
xdot(31) =a_HSC_MEP*3*(x27-x31);
xdot(32) =a_HSC_MEP*3*(x31-x32);
xdot(33) =a_HSC_MEP*3*(x32-x33);
...
xdot(40) =+2*b_HSC*3*x30-(b_HSC*3+a_HSC_MEP*3+a_HSC_MPP*3+g_HSC*3)*x40;
xdot(41) =+b_HSC*3*(x40-x41);
xdot(42) =+b_HSC*3*(x41-x42);
xdot(43) =+b_HSC*3*(x42-x43);
xdot(44) =a_HSC_MEP*3*(x40-x44);
xdot(45) =a_HSC_MEP*3*(x44-x45);
xdot(46) =a_HSC_MEP*3*(x45-x46);
...
xdot(53) =+2*b_HSC*3*x43-(b_HSC*3+a_HSC_MEP*3+a_HSC_MPP*3+g_HSC*3)*x53;
xdot(54) =+b_HSC*3*(x53-x54);
xdot(55) =+b_HSC*3*(x54-x55);
xdot(56) =+b_HSC*3*(x55-x56);
xdot(57) =a_HSC_MEP*3*(x53-x57);
xdot(58) =a_HSC_MEP*3*(x57-x58);
xdot(59) =a_HSC_MEP*3*(x58-x59);
...
xdot(66) =+2*b_HSC*3*x56-(b_HSC*3+a_HSC_MEP*3+a_HSC_MPP*3+g_HSC*3)*x66;
xdot(67) =+b_HSC*3*(x66-x67);
xdot(68) =+b_HSC*3*(x67-x68);
xdot(69) =+b_HSC*3*(x68-x69);
xdot(70) =a_HSC_MEP*3*(x66-x70);
xdot(71) =a_HSC_MEP*3*(x70-x71);
xdot(72) =a_HSC_MEP*3*(x71-x72);
...
xdot(79) =+2*b_HSC*3*x69+2*b_HSC*3*x82-(b_HSC*3+a_HSC_MEP*3+a_HSC_MPP*3+g_HSC*3)*x79;
xdot(80) =+b_HSC*3*(x79-x80);
xdot(81) =+b_HSC*3*(x80-x81);
xdot(82) =+b_HSC*3*(x81-x82);
xdot(83) =a_HSC_MEP*3*(x79-x83);
xdot(84) =a_HSC_MEP*3*(x83-x84);
xdot(85) =a_HSC_MEP*3*(x84-x85);
...
%MPP
xdot(92) =a_HSC_MPP*3*x10-(b_MPP*3+a_MPP_CMP*3+a_MPP_MLP*3+g_MPP*3)*x92;
...
xdot(105) =a_HSC_MPP*3*x23+2*b_MPP*3*x95-(b_MPP*3+a_MPP_CMP*3+a_MPP_MLP*3+g_MPP*3)*x105;
...
xdot(118) =a_HSC_MPP*3*x36+2*b_MPP*3*x108-(b_MPP*3+a_MPP_CMP*3+a_MPP_MLP*3+g_MPP*3)*x118;
...
xdot(131) =a_HSC_MPP*3*x49+2*b_MPP*3*x121-(b_MPP*3+a_MPP_CMP*3+a_MPP_MLP*3+g_MPP*3)*x131;
...
xdot(144) =a_HSC_MPP*3*x62+2*b_MPP*3*x134-(b_MPP*3+a_MPP_CMP*3+a_MPP_MLP*3+g_MPP*3)*x144;
...
xdot(157) =a_HSC_MPP*3*x75+2*b_MPP*3*x147-(b_MPP*3+a_MPP_CMP*3+a_MPP_MLP*3+g_MPP*3)*x157;
...
xdot(170) =a_HSC_MPP*3*x88+2*b_MPP*3*x160+2*b_MPP*3*x173-(b_MPP*3+a_MPP_CMP*3+a_MPP_MLP*3+g_MPP*3)*x170;
...
%CMP
xdot(232) =a_MPP_CMP*3*x98-(b_CMP*3+a_CMP_GMP*3+g_CMP*3)*x232;
...
xdot(239) =g_CMP*3*(x232-x239);
xdot(240) =g_CMP*3*(x239-x240);
xdot(241) =g_CMP*3*(x240-x241);
xdot(242) =a_MPP_CMP*3*x111+2*b_CMP*3*x235-(b_CMP*3+a_CMP_GMP*3+g_CMP*3)*x242;
xdot(243) =+b_CMP*3*(x242-x243);
xdot(244) =+b_CMP*3*(x243-x244);
xdot(245) =+b_CMP*3*(x244-x245);
xdot(246) =a_CMP_GMP*3*(x242-x246);
xdot(247) =a_CMP_GMP*3*(x246-x247);
xdot(248) =a_CMP_GMP*3*(x247-x248);
xdot(249) =g_CMP*3*(x242-x249);
xdot(250) =g_CMP*3*(x249-x250);
xdot(251) =g_CMP*3*(x250-x251);
xdot(252) =a_MPP_CMP*3*x124+2*b_CMP*3*x245-(b_CMP*3+a_CMP_GMP*3+g_CMP*3)*x252;
xdot(253) =+b_CMP*3*(x252-x253);
xdot(254) =+b_CMP*3*(x253-x254);
xdot(255) =+b_CMP*3*(x254-x255);
xdot(256) =a_CMP_GMP*3*(x252-x256);
xdot(257) =a_CMP_GMP*3*(x256-x257);
xdot(258) =a_CMP_GMP*3*(x257-x258);
xdot(259) =g_CMP*3*(x252-x259);
xdot(260) =g_CMP*3*(x259-x260);
xdot(261) =g_CMP*3*(x260-x261);
xdot(262) =a_MPP_CMP*3*x137+2*b_CMP*3*x255-(b_CMP*3+a_CMP_GMP*3+g_CMP*3)*x262;
xdot(263) =+b_CMP*3*(x262-x263);
xdot(264) =+b_CMP*3*(x263-x264);
xdot(265) =+b_CMP*3*(x264-x265);
xdot(266) =a_CMP_GMP*3*(x262-x266);
xdot(267) =a_CMP_GMP*3*(x266-x267);
xdot(268) =a_CMP_GMP*3*(x267-x268);
xdot(269) =g_CMP*3*(x262-x269);
xdot(270) =g_CMP*3*(x269-x270);
xdot(271) =g_CMP*3*(x270-x271);
xdot(272) =a_MPP_CMP*3*x150+2*b_CMP*3*x265-(b_CMP*3+a_CMP_GMP*3+g_CMP*3)*x272;
xdot(273) =+b_CMP*3*(x272-x273);
xdot(274) =+b_CMP*3*(x273-x274);
xdot(275) =+b_CMP*3*(x274-x275);
xdot(276) =a_CMP_GMP*3*(x272-x276);
xdot(277) =a_CMP_GMP*3*(x276-x277);
xdot(278) =a_CMP_GMP*3*(x277-x278);
xdot(279) =g_CMP*3*(x272-x279);
xdot(280) =g_CMP*3*(x279-x280);
xdot(281) =g_CMP*3*(x280-x281);
xdot(282) =a_MPP_CMP*3*x163+2*b_CMP*3*x275-(b_CMP*3+a_CMP_GMP*3+g_CMP*3)*x282;
xdot(283) =+b_CMP*3*(x282-x283);
xdot(284) =+b_CMP*3*(x283-x284);
xdot(285) =+b_CMP*3*(x284-x285);
xdot(286) =a_CMP_GMP*3*(x282-x286);
xdot(287) =a_CMP_GMP*3*(x286-x287);
xdot(288) =a_CMP_GMP*3*(x287-x288);
xdot(289) =g_CMP*3*(x282-x289);
xdot(290) =g_CMP*3*(x289-x290);
xdot(291) =g_CMP*3*(x290-x291);
xdot(292) =a_MPP_CMP*3*x176+2*b_CMP*3*x285+2*b_CMP*3*x295-(b_CMP*3+a_CMP_GMP*3+g_CMP*3)*x292;
xdot(293) =+b_CMP*3*(x292-x293);
xdot(294) =+b_CMP*3*(x293-x294);
xdot(295) =+b_CMP*3*(x294-x295);
xdot(296) =a_CMP_GMP*3*(x292-x296);
xdot(297) =a_CMP_GMP*3*(x296-x297);
xdot(298) =a_CMP_GMP*3*(x297-x298);
xdot(299) =g_CMP*3*(x292-x299);
xdot(300) =g_CMP*3*(x299-x300);
xdot(301) =g_CMP*3*(x300-x301);

%GMP
xdot(302) =a_CMP_GMP*3*x238-(b_GMP*3+a_GMP_mat*3+g_GMP*3)*x302;
...
xdot(312) =a_CMP_GMP*3*x248+2*b_GMP*3*x305-(b_GMP*3+a_GMP_mat*3+g_GMP*3)*x312;
...
xdot(322) =a_CMP_GMP*3*x258+2*b_GMP*3*x315-(b_GMP*3+a_GMP_mat*3+g_GMP*3)*x322;
...
xdot(332) =a_CMP_GMP*3*x268+2*b_GMP*3*x325-(b_GMP*3+a_GMP_mat*3+g_GMP*3)*x332;
...
xdot(342) =a_CMP_GMP*3*x278+2*b_GMP*3*x335-(b_GMP*3+a_GMP_mat*3+g_GMP*3)*x342;
...
xdot(352) =a_CMP_GMP*3*x288+2*b_GMP*3*x345-(b_GMP*3+a_GMP_mat*3+g_GMP*3)*x352;
...
xdot(362) =a_CMP_GMP*3*x298+2*b_GMP*3*x355+2*b_GMP*3*x365-(b_GMP*3+a_GMP_mat*3+g_GMP*3)*x362;
...
%MEP
xdot(372) =a_HSC_MEP*3*x7-(b_MEP*3+a_MEP_mat*3+g_MEP*3)*x372;
...
xdot(382) =a_HSC_MEP*3*x20+2*b_MEP*3*x375-(b_MEP*3+a_MEP_mat*3+g_MEP*3)*x382;
...
xdot(392) =a_HSC_MEP*3*x33+2*b_MEP*3*x385-(b_MEP*3+a_MEP_mat*3+g_MEP*3)*x392;
...
xdot(402) =a_HSC_MEP*3*x46+2*b_MEP*3*x395-(b_MEP*3+a_MEP_mat*3+g_MEP*3)*x402;
...
xdot(412) =a_HSC_MEP*3*x59+2*b_MEP*3*x405-(b_MEP*3+a_MEP_mat*3+g_MEP*3)*x412;
...
xdot(422) =a_HSC_MEP*3*x72+2*b_MEP*3*x415-(b_MEP*3+a_MEP_mat*3+g_MEP*3)*x422;
...
xdot(432) =a_HSC_MEP*3*x85+2*b_MEP*3*x425+2*b_MEP*3*x435-(b_MEP*3+a_MEP_mat*3+g_MEP*3)*x432;
...
%mat
xdot(442) =a_MEP_mat*3*x378+a_GMP_mat*3*x308-(b_mat*3+g_mat*3)*x442;
...
xdot(449) =a_MEP_mat*3*x388+a_GMP_mat*3*x318+2*b_mat*3*x445-(b_mat*3+g_mat*3)*x449;
...
xdot(456) =a_MEP_mat*3*x398+a_GMP_mat*3*x328+2*b_mat*3*x452-(b_mat*3+g_mat*3)*x456;
...
xdot(463) =a_MEP_mat*3*x408+a_GMP_mat*3*x338+2*b_mat*3*x459-(b_mat*3+g_mat*3)*x463;
...
xdot(470) =a_MEP_mat*3*x418+a_GMP_mat*3*x348+2*b_mat*3*x466-(b_mat*3+g_mat*3)*x470;
...
xdot(477) =a_MEP_mat*3*x428+a_GMP_mat*3*x358+2*b_mat*3*x473-(b_mat*3+g_mat*3)*x477;
...
xdot(484) =a_MEP_mat*3*x438+a_GMP_mat*3*x368+2*b_mat*3*x480+2*b_mat*3*x487-(b_mat*3+g_mat*3)*x484;
...
% INITIAL CONDITIONS
x0 = sym(zeros(size(x)));
x0([1,92,183,232,302,372,442])=exp(p(1:7))-1;
...
for i=1:7
y(21+i) = log(sum(x((i-1)*10+232:i*10+232-1))+1);
end
for i=1:7
