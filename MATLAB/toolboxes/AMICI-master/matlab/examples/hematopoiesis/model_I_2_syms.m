...
%MLP
xdot(127) =a_MPP_MLP*2*x70-(b_MLP*2+a_MLP*2+a_MLP_GMP*2)*x127;
xdot(128) =+b_MLP*2*(x127-x128);
xdot(129) =+b_MLP*2*(x128-x129);
xdot(130) =a_MLP*2*(x127-x130);
xdot(131) =a_MLP*2*(x130-x131);
xdot(132) =a_MLP_GMP*2*(x127-x132);
xdot(133) =a_MLP_GMP*2*(x132-x133);
xdot(134) =a_MPP_MLP*2*x79+2*b_MLP*2*x129-(b_MLP*2+a_MLP*2+a_MLP_GMP*2)*x134;
xdot(135) =+b_MLP*2*(x134-x135);
xdot(136) =+b_MLP*2*(x135-x136);
xdot(137) =a_MLP*2*(x134-x137);
xdot(138) =a_MLP*2*(x137-x138);
xdot(139) =a_MLP_GMP*2*(x134-x139);
xdot(140) =a_MLP_GMP*2*(x139-x140);
xdot(141) =a_MPP_MLP*2*x88+2*b_MLP*2*x136-(b_MLP*2+a_MLP*2+a_MLP_GMP*2)*x141;
...
xdot(148) =a_MPP_MLP*2*x97+2*b_MLP*2*x143-(b_MLP*2+a_MLP*2+a_MLP_GMP*2)*x148;
...
xdot(155) =a_MPP_MLP*2*x106+2*b_MLP*2*x150-(b_MLP*2+a_MLP*2+a_MLP_GMP*2)*x155;
...
xdot(162) =a_MPP_MLP*2*x115+2*b_MLP*2*x157-(b_MLP*2+a_MLP*2+a_MLP_GMP*2)*x162;
...
xdot(169) =a_MPP_MLP*2*x124+2*b_MLP*2*x164+2*b_MLP*2*x171-(b_MLP*2+a_MLP*2+a_MLP_GMP*2)*x169;
...
%CMP
xdot(176) =a_MPP_CMP*2*x68-(b_CMP*2+a_CMP_GMP*2+g_CMP*2)*x176;
xdot(177) =+b_CMP*2*(x176-x177);
xdot(178) =+b_CMP*2*(x177-x178);
xdot(179) =a_CMP_GMP*2*(x176-x179);
xdot(180) =a_CMP_GMP*2*(x179-x180);
xdot(181) =g_CMP*2*(x176-x181);
xdot(182) =g_CMP*2*(x181-x182);
xdot(183) =a_MPP_CMP*2*x77+2*b_CMP*2*x178-(b_CMP*2+a_CMP_GMP*2+g_CMP*2)*x183;
xdot(184) =+b_CMP*2*(x183-x184);
xdot(185) =+b_CMP*2*(x184-x185);
xdot(186) =a_CMP_GMP*2*(x183-x186);
xdot(187) =a_CMP_GMP*2*(x186-x187);
xdot(188) =g_CMP*2*(x183-x188);
xdot(189) =g_CMP*2*(x188-x189);
xdot(190) =a_MPP_CMP*2*x86+2*b_CMP*2*x185-(b_CMP*2+a_CMP_GMP*2+g_CMP*2)*x190;
xdot(191) =+b_CMP*2*(x190-x191);
xdot(192) =+b_CMP*2*(x191-x192);
xdot(193) =a_CMP_GMP*2*(x190-x193);
xdot(194) =a_CMP_GMP*2*(x193-x194);
xdot(195) =g_CMP*2*(x190-x195);
xdot(196) =g_CMP*2*(x195-x196);
xdot(197) =a_MPP_CMP*2*x95+2*b_CMP*2*x192-(b_CMP*2+a_CMP_GMP*2+g_CMP*2)*x197;
xdot(198) =+b_CMP*2*(x197-x198);
xdot(199) =+b_CMP*2*(x198-x199);
xdot(200) =a_CMP_GMP*2*(x197-x200);
xdot(201) =a_CMP_GMP*2*(x200-x201);
xdot(202) =g_CMP*2*(x197-x202);
xdot(203) =g_CMP*2*(x202-x203);
xdot(204) =a_MPP_CMP*2*x104+2*b_CMP*2*x199-(b_CMP*2+a_CMP_GMP*2+g_CMP*2)*x204;
xdot(205) =+b_CMP*2*(x204-x205);
xdot(206) =+b_CMP*2*(x205-x206);
xdot(207) =a_CMP_GMP*2*(x204-x207);
xdot(208) =a_CMP_GMP*2*(x207-x208);
xdot(209) =g_CMP*2*(x204-x209);
xdot(210) =g_CMP*2*(x209-x210);
xdot(211) =a_MPP_CMP*2*x113+2*b_CMP*2*x206-(b_CMP*2+a_CMP_GMP*2+g_CMP*2)*x211;
xdot(212) =+b_CMP*2*(x211-x212);
xdot(213) =+b_CMP*2*(x212-x213);
xdot(214) =a_CMP_GMP*2*(x211-x214);
xdot(215) =a_CMP_GMP*2*(x214-x215);
xdot(216) =g_CMP*2*(x211-x216);
xdot(217) =g_CMP*2*(x216-x217);
xdot(218) =a_MPP_CMP*2*x122+2*b_CMP*2*x213+2*b_CMP*2*x220-(b_CMP*2+a_CMP_GMP*2+g_CMP*2)*x218;
xdot(219) =+b_CMP*2*(x218-x219);
xdot(220) =+b_CMP*2*(x219-x220);
xdot(221) =a_CMP_GMP*2*(x218-x221);
xdot(222) =a_CMP_GMP*2*(x221-x222);
xdot(223) =g_CMP*2*(x218-x223);
xdot(224) =g_CMP*2*(x223-x224);

%GMP
xdot(225) =a_CMP_GMP*2*x180+a_MLP_GMP*2*x133-(b_GMP*2+a_GMP_mat*2+g_GMP*2)*x225;
...
xdot(232) =a_CMP_GMP*2*x187+a_MLP_GMP*2*x140+2*b_GMP*2*x227-(b_GMP*2+a_GMP_mat*2+g_GMP*2)*x232;
...
xdot(239) =a_CMP_GMP*2*x194+a_MLP_GMP*2*x147+2*b_GMP*2*x234-(b_GMP*2+a_GMP_mat*2+g_GMP*2)*x239;
...
xdot(246) =a_CMP_GMP*2*x201+a_MLP_GMP*2*x154+2*b_GMP*2*x241-(b_GMP*2+a_GMP_mat*2+g_GMP*2)*x246;
...
xdot(253) =a_CMP_GMP*2*x208+a_MLP_GMP*2*x161+2*b_GMP*2*x248-(b_GMP*2+a_GMP_mat*2+g_GMP*2)*x253;
...
xdot(260) =a_CMP_GMP*2*x215+a_MLP_GMP*2*x168+2*b_GMP*2*x255-(b_GMP*2+a_GMP_mat*2+g_GMP*2)*x260;
...
xdot(267) =a_CMP_GMP*2*x222+a_MLP_GMP*2*x175+2*b_GMP*2*x262+2*b_GMP*2*x269-(b_GMP*2+a_GMP_mat*2+g_GMP*2)*x267;
...
%MEP
xdot(274) =a_HSC_MEP*2*x7-(b_MEP*2+a_MEP_mat*2+g_MEP*2)*x274;
...
xdot(281) =a_HSC_MEP*2*x16+2*b_MEP*2*x276-(b_MEP*2+a_MEP_mat*2+g_MEP*2)*x281;
...
xdot(288) =a_HSC_MEP*2*x25+2*b_MEP*2*x283-(b_MEP*2+a_MEP_mat*2+g_MEP*2)*x288;
...
xdot(295) =a_HSC_MEP*2*x34+2*b_MEP*2*x290-(b_MEP*2+a_MEP_mat*2+g_MEP*2)*x295;
...
xdot(302) =a_HSC_MEP*2*x43+2*b_MEP*2*x297-(b_MEP*2+a_MEP_mat*2+g_MEP*2)*x302;
...
xdot(309) =a_HSC_MEP*2*x52+2*b_MEP*2*x304-(b_MEP*2+a_MEP_mat*2+g_MEP*2)*x309;
...
xdot(316) =a_HSC_MEP*2*x61+2*b_MEP*2*x311+2*b_MEP*2*x318-(b_MEP*2+a_MEP_mat*2+g_MEP*2)*x316;
...
% INITIAL CONDITIONS
x0 = sym(zeros(size(x)));
x0([1,64,127,176,225,274,323])=exp(p(1:7))-1;
...
for i=1:7
y(14+i) = log(sum(x((i-1)*7+127:i*7+127-1))+1);
end
for i=1:7
y(21+i) = log(sum(x((i-1)*7+176:i*7+176-1))+1);
end
for i=1:7
