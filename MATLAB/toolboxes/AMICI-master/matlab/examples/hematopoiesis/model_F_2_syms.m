...
%MPP
xdot(64) =a_HSC_MPP*2*x7-(b_MPP*2+a_MPP_GMP*2+a_MPP_MLP*2+g_MPP*2)*x64;
...
xdot(73) =a_HSC_MPP*2*x16+2*b_MPP*2*x66-(b_MPP*2+a_MPP_GMP*2+a_MPP_MLP*2+g_MPP*2)*x73;
xdot(74) =+b_MPP*2*(x73-x74);
xdot(75) =+b_MPP*2*(x74-x75);
xdot(76) =a_MPP_GMP*2*(x73-x76);
xdot(77) =a_MPP_GMP*2*(x76-x77);
xdot(78) =a_MPP_MLP*2*(x73-x78);
xdot(79) =a_MPP_MLP*2*(x78-x79);
xdot(80) =g_MPP*2*(x73-x80);
xdot(81) =g_MPP*2*(x80-x81);
xdot(82) =a_HSC_MPP*2*x25+2*b_MPP*2*x75-(b_MPP*2+a_MPP_GMP*2+a_MPP_MLP*2+g_MPP*2)*x82;
xdot(83) =+b_MPP*2*(x82-x83);
xdot(84) =+b_MPP*2*(x83-x84);
xdot(85) =a_MPP_GMP*2*(x82-x85);
xdot(86) =a_MPP_GMP*2*(x85-x86);
xdot(87) =a_MPP_MLP*2*(x82-x87);
xdot(88) =a_MPP_MLP*2*(x87-x88);
xdot(89) =g_MPP*2*(x82-x89);
xdot(90) =g_MPP*2*(x89-x90);
xdot(91) =a_HSC_MPP*2*x34+2*b_MPP*2*x84-(b_MPP*2+a_MPP_GMP*2+a_MPP_MLP*2+g_MPP*2)*x91;
xdot(92) =+b_MPP*2*(x91-x92);
xdot(93) =+b_MPP*2*(x92-x93);
xdot(94) =a_MPP_GMP*2*(x91-x94);
xdot(95) =a_MPP_GMP*2*(x94-x95);
xdot(96) =a_MPP_MLP*2*(x91-x96);
xdot(97) =a_MPP_MLP*2*(x96-x97);
xdot(98) =g_MPP*2*(x91-x98);
xdot(99) =g_MPP*2*(x98-x99);
xdot(100) =a_HSC_MPP*2*x43+2*b_MPP*2*x93-(b_MPP*2+a_MPP_GMP*2+a_MPP_MLP*2+g_MPP*2)*x100;
xdot(101) =+b_MPP*2*(x100-x101);
xdot(102) =+b_MPP*2*(x101-x102);
xdot(103) =a_MPP_GMP*2*(x100-x103);
xdot(104) =a_MPP_GMP*2*(x103-x104);
xdot(105) =a_MPP_MLP*2*(x100-x105);
xdot(106) =a_MPP_MLP*2*(x105-x106);
xdot(107) =g_MPP*2*(x100-x107);
xdot(108) =g_MPP*2*(x107-x108);
xdot(109) =a_HSC_MPP*2*x52+2*b_MPP*2*x102-(b_MPP*2+a_MPP_GMP*2+a_MPP_MLP*2+g_MPP*2)*x109;
xdot(110) =+b_MPP*2*(x109-x110);
xdot(111) =+b_MPP*2*(x110-x111);
xdot(112) =a_MPP_GMP*2*(x109-x112);
xdot(113) =a_MPP_GMP*2*(x112-x113);
xdot(114) =a_MPP_MLP*2*(x109-x114);
xdot(115) =a_MPP_MLP*2*(x114-x115);
xdot(116) =g_MPP*2*(x109-x116);
xdot(117) =g_MPP*2*(x116-x117);
xdot(118) =a_HSC_MPP*2*x61+2*b_MPP*2*x111+2*b_MPP*2*x120-(b_MPP*2+a_MPP_GMP*2+a_MPP_MLP*2+g_MPP*2)*x118;
xdot(119) =+b_MPP*2*(x118-x119);
xdot(120) =+b_MPP*2*(x119-x120);
xdot(121) =a_MPP_GMP*2*(x118-x121);
xdot(122) =a_MPP_GMP*2*(x121-x122);
...
%CMP
xdot(162) =a_HSC_CMP*2*x5-(b_CMP*2+a_CMP_MEP*2+a_CMP_GMP*2+g_CMP*2)*x162;
...
xdot(171) =a_HSC_CMP*2*x14+2*b_CMP*2*x164-(b_CMP*2+a_CMP_MEP*2+a_CMP_GMP*2+g_CMP*2)*x171;
...
xdot(180) =a_HSC_CMP*2*x23+2*b_CMP*2*x173-(b_CMP*2+a_CMP_MEP*2+a_CMP_GMP*2+g_CMP*2)*x180;
...
xdot(189) =a_HSC_CMP*2*x32+2*b_CMP*2*x182-(b_CMP*2+a_CMP_MEP*2+a_CMP_GMP*2+g_CMP*2)*x189;
...
xdot(198) =a_HSC_CMP*2*x41+2*b_CMP*2*x191-(b_CMP*2+a_CMP_MEP*2+a_CMP_GMP*2+g_CMP*2)*x198;
...
xdot(207) =a_HSC_CMP*2*x50+2*b_CMP*2*x200-(b_CMP*2+a_CMP_MEP*2+a_CMP_GMP*2+g_CMP*2)*x207;
...
xdot(216) =a_HSC_CMP*2*x59+2*b_CMP*2*x209+2*b_CMP*2*x218-(b_CMP*2+a_CMP_MEP*2+a_CMP_GMP*2+g_CMP*2)*x216;
...
%GMP
xdot(225) =a_CMP_GMP*2*x168+a_MPP_GMP*2*x68-(b_GMP*2+a_GMP_mat*2+g_GMP*2)*x225;
...
xdot(232) =a_CMP_GMP*2*x177+a_MPP_GMP*2*x77+2*b_GMP*2*x227-(b_GMP*2+a_GMP_mat*2+g_GMP*2)*x232;
...
xdot(239) =a_CMP_GMP*2*x186+a_MPP_GMP*2*x86+2*b_GMP*2*x234-(b_GMP*2+a_GMP_mat*2+g_GMP*2)*x239;
...
xdot(246) =a_CMP_GMP*2*x195+a_MPP_GMP*2*x95+2*b_GMP*2*x241-(b_GMP*2+a_GMP_mat*2+g_GMP*2)*x246;
...
xdot(253) =a_CMP_GMP*2*x204+a_MPP_GMP*2*x104+2*b_GMP*2*x248-(b_GMP*2+a_GMP_mat*2+g_GMP*2)*x253;
...
xdot(260) =a_CMP_GMP*2*x213+a_MPP_GMP*2*x113+2*b_GMP*2*x255-(b_GMP*2+a_GMP_mat*2+g_GMP*2)*x260;
...
xdot(267) =a_CMP_GMP*2*x222+a_MPP_GMP*2*x122+2*b_GMP*2*x262+2*b_GMP*2*x269-(b_GMP*2+a_GMP_mat*2+g_GMP*2)*x267;
