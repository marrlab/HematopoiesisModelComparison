...
%CMP
xdot(330) =a_MPP_CMP*4*x128-(b_CMP*4+a_CMP_MEP*4+a_CMP_GMP*4+g_CMP*4)*x330;
...
xdot(347) =a_MPP_CMP*4*x145+2*b_CMP*4*x334-(b_CMP*4+a_CMP_MEP*4+a_CMP_GMP*4+g_CMP*4)*x347;
...
xdot(364) =a_MPP_CMP*4*x162+2*b_CMP*4*x351-(b_CMP*4+a_CMP_MEP*4+a_CMP_GMP*4+g_CMP*4)*x364;
...
xdot(381) =a_MPP_CMP*4*x179+2*b_CMP*4*x368-(b_CMP*4+a_CMP_MEP*4+a_CMP_GMP*4+g_CMP*4)*x381;
...
xdot(398) =a_MPP_CMP*4*x196+2*b_CMP*4*x385-(b_CMP*4+a_CMP_MEP*4+a_CMP_GMP*4+g_CMP*4)*x398;
...
xdot(415) =a_MPP_CMP*4*x213+2*b_CMP*4*x402-(b_CMP*4+a_CMP_MEP*4+a_CMP_GMP*4+g_CMP*4)*x415;
...
xdot(432) =a_MPP_CMP*4*x230+2*b_CMP*4*x419+2*b_CMP*4*x436-(b_CMP*4+a_CMP_MEP*4+a_CMP_GMP*4+g_CMP*4)*x432;
...
%GMP
xdot(449) =a_CMP_GMP*4*x342+a_MLP_GMP*4*x251-(b_GMP*4+a_GMP_mat*4+g_GMP*4)*x449;
...
xdot(462) =a_CMP_GMP*4*x359+a_MLP_GMP*4*x264+2*b_GMP*4*x453-(b_GMP*4+a_GMP_mat*4+g_GMP*4)*x462;
...
xdot(475) =a_CMP_GMP*4*x376+a_MLP_GMP*4*x277+2*b_GMP*4*x466-(b_GMP*4+a_GMP_mat*4+g_GMP*4)*x475;
...
xdot(488) =a_CMP_GMP*4*x393+a_MLP_GMP*4*x290+2*b_GMP*4*x479-(b_GMP*4+a_GMP_mat*4+g_GMP*4)*x488;
...
xdot(501) =a_CMP_GMP*4*x410+a_MLP_GMP*4*x303+2*b_GMP*4*x492-(b_GMP*4+a_GMP_mat*4+g_GMP*4)*x501;
...
xdot(514) =a_CMP_GMP*4*x427+a_MLP_GMP*4*x316+2*b_GMP*4*x505-(b_GMP*4+a_GMP_mat*4+g_GMP*4)*x514;
...
xdot(527) =a_CMP_GMP*4*x444+a_MLP_GMP*4*x329+2*b_GMP*4*x518+2*b_GMP*4*x531-(b_GMP*4+a_GMP_mat*4+g_GMP*4)*x527;
...
%MEP
xdot(540) =a_CMP_MEP*4*x338-(b_MEP*4+a_MEP_mat*4+g_MEP*4)*x540;
...
xdot(553) =a_CMP_MEP*4*x355+2*b_MEP*4*x544-(b_MEP*4+a_MEP_mat*4+g_MEP*4)*x553;
...
xdot(566) =a_CMP_MEP*4*x372+2*b_MEP*4*x557-(b_MEP*4+a_MEP_mat*4+g_MEP*4)*x566;
...
xdot(579) =a_CMP_MEP*4*x389+2*b_MEP*4*x570-(b_MEP*4+a_MEP_mat*4+g_MEP*4)*x579;
...
xdot(592) =a_CMP_MEP*4*x406+2*b_MEP*4*x583-(b_MEP*4+a_MEP_mat*4+g_MEP*4)*x592;
...
xdot(605) =a_CMP_MEP*4*x423+2*b_MEP*4*x596-(b_MEP*4+a_MEP_mat*4+g_MEP*4)*x605;
...
xdot(618) =a_CMP_MEP*4*x440+2*b_MEP*4*x609+2*b_MEP*4*x622-(b_MEP*4+a_MEP_mat*4+g_MEP*4)*x618;
...
%mat
xdot(631) =a_HSC_mat*4*x13+a_MEP_mat*4*x548+a_GMP_mat*4*x457-(b_mat*4+g_mat*4)*x631;
...
xdot(640) =a_HSC_mat*4*x30+a_MEP_mat*4*x561+a_GMP_mat*4*x470+2*b_mat*4*x635-(b_mat*4+g_mat*4)*x640;
...
xdot(649) =a_HSC_mat*4*x47+a_MEP_mat*4*x574+a_GMP_mat*4*x483+2*b_mat*4*x644-(b_mat*4+g_mat*4)*x649;
...
xdot(658) =a_HSC_mat*4*x64+a_MEP_mat*4*x587+a_GMP_mat*4*x496+2*b_mat*4*x653-(b_mat*4+g_mat*4)*x658;
...
xdot(667) =a_HSC_mat*4*x81+a_MEP_mat*4*x600+a_GMP_mat*4*x509+2*b_mat*4*x662-(b_mat*4+g_mat*4)*x667;
...
xdot(676) =a_HSC_mat*4*x98+a_MEP_mat*4*x613+a_GMP_mat*4*x522+2*b_mat*4*x671-(b_mat*4+g_mat*4)*x676;
...
xdot(685) =a_HSC_mat*4*x115+a_MEP_mat*4*x626+a_GMP_mat*4*x535+2*b_mat*4*x680+2*b_mat*4*x689-(b_mat*4+g_mat*4)*x685;
...
% INITIAL CONDITIONS
x0 = sym(zeros(size(x)));
x0([1,120,239,330,449,540,631])=exp(p(1:7))-1;
