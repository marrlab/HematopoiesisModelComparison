...
%MPP
xdot(92) =a_HSC_MPP*3*x10-(b_MPP*3+a_MPP_GMP*3+a_MPP_MLP*3+g_MPP*3)*x92;
...
xdot(105) =a_HSC_MPP*3*x23+2*b_MPP*3*x95-(b_MPP*3+a_MPP_GMP*3+a_MPP_MLP*3+g_MPP*3)*x105;
xdot(106) =+b_MPP*3*(x105-x106);
xdot(107) =+b_MPP*3*(x106-x107);
xdot(108) =+b_MPP*3*(x107-x108);
xdot(109) =a_MPP_GMP*3*(x105-x109);
xdot(110) =a_MPP_GMP*3*(x109-x110);
xdot(111) =a_MPP_GMP*3*(x110-x111);
...
xdot(118) =a_HSC_MPP*3*x36+2*b_MPP*3*x108-(b_MPP*3+a_MPP_GMP*3+a_MPP_MLP*3+g_MPP*3)*x118;
xdot(119) =+b_MPP*3*(x118-x119);
xdot(120) =+b_MPP*3*(x119-x120);
xdot(121) =+b_MPP*3*(x120-x121);
xdot(122) =a_MPP_GMP*3*(x118-x122);
xdot(123) =a_MPP_GMP*3*(x122-x123);
xdot(124) =a_MPP_GMP*3*(x123-x124);
...
xdot(131) =a_HSC_MPP*3*x49+2*b_MPP*3*x121-(b_MPP*3+a_MPP_GMP*3+a_MPP_MLP*3+g_MPP*3)*x131;
xdot(132) =+b_MPP*3*(x131-x132);
xdot(133) =+b_MPP*3*(x132-x133);
xdot(134) =+b_MPP*3*(x133-x134);
xdot(135) =a_MPP_GMP*3*(x131-x135);
xdot(136) =a_MPP_GMP*3*(x135-x136);
xdot(137) =a_MPP_GMP*3*(x136-x137);
...
xdot(144) =a_HSC_MPP*3*x62+2*b_MPP*3*x134-(b_MPP*3+a_MPP_GMP*3+a_MPP_MLP*3+g_MPP*3)*x144;
xdot(145) =+b_MPP*3*(x144-x145);
xdot(146) =+b_MPP*3*(x145-x146);
xdot(147) =+b_MPP*3*(x146-x147);
xdot(148) =a_MPP_GMP*3*(x144-x148);
xdot(149) =a_MPP_GMP*3*(x148-x149);
xdot(150) =a_MPP_GMP*3*(x149-x150);
...
xdot(157) =a_HSC_MPP*3*x75+2*b_MPP*3*x147-(b_MPP*3+a_MPP_GMP*3+a_MPP_MLP*3+g_MPP*3)*x157;
xdot(158) =+b_MPP*3*(x157-x158);
xdot(159) =+b_MPP*3*(x158-x159);
xdot(160) =+b_MPP*3*(x159-x160);
xdot(161) =a_MPP_GMP*3*(x157-x161);
xdot(162) =a_MPP_GMP*3*(x161-x162);
xdot(163) =a_MPP_GMP*3*(x162-x163);
...
xdot(170) =a_HSC_MPP*3*x88+2*b_MPP*3*x160+2*b_MPP*3*x173-(b_MPP*3+a_MPP_GMP*3+a_MPP_MLP*3+g_MPP*3)*x170;
xdot(171) =+b_MPP*3*(x170-x171);
xdot(172) =+b_MPP*3*(x171-x172);
xdot(173) =+b_MPP*3*(x172-x173);
xdot(174) =a_MPP_GMP*3*(x170-x174);
xdot(175) =a_MPP_GMP*3*(x174-x175);
xdot(176) =a_MPP_GMP*3*(x175-x176);
...
%CMP
xdot(232) =a_HSC_CMP*3*x7-(b_CMP*3+a_CMP_MEP*3+a_CMP_GMP*3+g_CMP*3)*x232;
...
xdot(245) =a_HSC_CMP*3*x20+2*b_CMP*3*x235-(b_CMP*3+a_CMP_MEP*3+a_CMP_GMP*3+g_CMP*3)*x245;
...
xdot(258) =a_HSC_CMP*3*x33+2*b_CMP*3*x248-(b_CMP*3+a_CMP_MEP*3+a_CMP_GMP*3+g_CMP*3)*x258;
...
xdot(271) =a_HSC_CMP*3*x46+2*b_CMP*3*x261-(b_CMP*3+a_CMP_MEP*3+a_CMP_GMP*3+g_CMP*3)*x271;
...
xdot(284) =a_HSC_CMP*3*x59+2*b_CMP*3*x274-(b_CMP*3+a_CMP_MEP*3+a_CMP_GMP*3+g_CMP*3)*x284;
...
xdot(297) =a_HSC_CMP*3*x72+2*b_CMP*3*x287-(b_CMP*3+a_CMP_MEP*3+a_CMP_GMP*3+g_CMP*3)*x297;
...
xdot(310) =a_HSC_CMP*3*x85+2*b_CMP*3*x300+2*b_CMP*3*x313-(b_CMP*3+a_CMP_MEP*3+a_CMP_GMP*3+g_CMP*3)*x310;
...
%GMP
xdot(323) =a_CMP_GMP*3*x241+a_MPP_GMP*3*x98-(b_GMP*3+a_GMP_mat*3+g_GMP*3)*x323;
...
xdot(333) =a_CMP_GMP*3*x254+a_MPP_GMP*3*x111+2*b_GMP*3*x326-(b_GMP*3+a_GMP_mat*3+g_GMP*3)*x333;
...
xdot(343) =a_CMP_GMP*3*x267+a_MPP_GMP*3*x124+2*b_GMP*3*x336-(b_GMP*3+a_GMP_mat*3+g_GMP*3)*x343;
...
xdot(353) =a_CMP_GMP*3*x280+a_MPP_GMP*3*x137+2*b_GMP*3*x346-(b_GMP*3+a_GMP_mat*3+g_GMP*3)*x353;
...
xdot(363) =a_CMP_GMP*3*x293+a_MPP_GMP*3*x150+2*b_GMP*3*x356-(b_GMP*3+a_GMP_mat*3+g_GMP*3)*x363;
...
xdot(373) =a_CMP_GMP*3*x306+a_MPP_GMP*3*x163+2*b_GMP*3*x366-(b_GMP*3+a_GMP_mat*3+g_GMP*3)*x373;
...
xdot(383) =a_CMP_GMP*3*x319+a_MPP_GMP*3*x176+2*b_GMP*3*x376+2*b_GMP*3*x386-(b_GMP*3+a_GMP_mat*3+g_GMP*3)*x383;
