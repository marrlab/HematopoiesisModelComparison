...
%MLP
xdot(113) =a_MPP_MLP*2*x54-(b_MLP*2+a_MLP*2+a_MLP_GMP*2)*x113;
xdot(114) =+b_MLP*2*(x113-x114);
xdot(115) =+b_MLP*2*(x114-x115);
xdot(116) =a_MLP*2*(x113-x116);
xdot(117) =a_MLP*2*(x116-x117);
xdot(118) =a_MLP_GMP*2*(x113-x118);
xdot(119) =a_MLP_GMP*2*(x118-x119);
xdot(120) =a_MPP_MLP*2*x63+2*b_MLP*2*x115-(b_MLP*2+a_MLP*2+a_MLP_GMP*2)*x120;
xdot(121) =+b_MLP*2*(x120-x121);
xdot(122) =+b_MLP*2*(x121-x122);
xdot(123) =a_MLP*2*(x120-x123);
xdot(124) =a_MLP*2*(x123-x124);
xdot(125) =a_MLP_GMP*2*(x120-x125);
xdot(126) =a_MLP_GMP*2*(x125-x126);
xdot(127) =a_MPP_MLP*2*x72+2*b_MLP*2*x122-(b_MLP*2+a_MLP*2+a_MLP_GMP*2)*x127;
...
xdot(134) =a_MPP_MLP*2*x81+2*b_MLP*2*x129-(b_MLP*2+a_MLP*2+a_MLP_GMP*2)*x134;
...
xdot(141) =a_MPP_MLP*2*x90+2*b_MLP*2*x136-(b_MLP*2+a_MLP*2+a_MLP_GMP*2)*x141;
...
xdot(148) =a_MPP_MLP*2*x99+2*b_MLP*2*x143-(b_MLP*2+a_MLP*2+a_MLP_GMP*2)*x148;
...
xdot(155) =a_MPP_MLP*2*x108+2*b_MLP*2*x150+2*b_MLP*2*x157-(b_MLP*2+a_MLP*2+a_MLP_GMP*2)*x155;
...
%CMP
xdot(162) =a_MPP_CMP*2*x56-(b_CMP*2+a_CMP_GMP*2+a_CMP_MEP*2+g_CMP*2)*x162;
xdot(163) =+b_CMP*2*(x162-x163);
xdot(164) =+b_CMP*2*(x163-x164);
xdot(165) =a_CMP_GMP*2*(x162-x165);
xdot(166) =a_CMP_GMP*2*(x165-x166);
xdot(167) =a_CMP_MEP*2*(x162-x167);
xdot(168) =a_CMP_MEP*2*(x167-x168);
xdot(169) =g_CMP*2*(x162-x169);
xdot(170) =g_CMP*2*(x169-x170);
xdot(171) =a_MPP_CMP*2*x65+2*b_CMP*2*x164-(b_CMP*2+a_CMP_GMP*2+a_CMP_MEP*2+g_CMP*2)*x171;
xdot(172) =+b_CMP*2*(x171-x172);
xdot(173) =+b_CMP*2*(x172-x173);
xdot(174) =a_CMP_GMP*2*(x171-x174);
xdot(175) =a_CMP_GMP*2*(x174-x175);
xdot(176) =a_CMP_MEP*2*(x171-x176);
xdot(177) =a_CMP_MEP*2*(x176-x177);
xdot(178) =g_CMP*2*(x171-x178);
xdot(179) =g_CMP*2*(x178-x179);
xdot(180) =a_MPP_CMP*2*x74+2*b_CMP*2*x173-(b_CMP*2+a_CMP_GMP*2+a_CMP_MEP*2+g_CMP*2)*x180;
xdot(181) =+b_CMP*2*(x180-x181);
xdot(182) =+b_CMP*2*(x181-x182);
xdot(183) =a_CMP_GMP*2*(x180-x183);
xdot(184) =a_CMP_GMP*2*(x183-x184);
xdot(185) =a_CMP_MEP*2*(x180-x185);
xdot(186) =a_CMP_MEP*2*(x185-x186);
xdot(187) =g_CMP*2*(x180-x187);
xdot(188) =g_CMP*2*(x187-x188);
xdot(189) =a_MPP_CMP*2*x83+2*b_CMP*2*x182-(b_CMP*2+a_CMP_GMP*2+a_CMP_MEP*2+g_CMP*2)*x189;
xdot(190) =+b_CMP*2*(x189-x190);
xdot(191) =+b_CMP*2*(x190-x191);
xdot(192) =a_CMP_GMP*2*(x189-x192);
xdot(193) =a_CMP_GMP*2*(x192-x193);
xdot(194) =a_CMP_MEP*2*(x189-x194);
xdot(195) =a_CMP_MEP*2*(x194-x195);
xdot(196) =g_CMP*2*(x189-x196);
xdot(197) =g_CMP*2*(x196-x197);
xdot(198) =a_MPP_CMP*2*x92+2*b_CMP*2*x191-(b_CMP*2+a_CMP_GMP*2+a_CMP_MEP*2+g_CMP*2)*x198;
xdot(199) =+b_CMP*2*(x198-x199);
xdot(200) =+b_CMP*2*(x199-x200);
xdot(201) =a_CMP_GMP*2*(x198-x201);
xdot(202) =a_CMP_GMP*2*(x201-x202);
xdot(203) =a_CMP_MEP*2*(x198-x203);
xdot(204) =a_CMP_MEP*2*(x203-x204);
xdot(205) =g_CMP*2*(x198-x205);
xdot(206) =g_CMP*2*(x205-x206);
xdot(207) =a_MPP_CMP*2*x101+2*b_CMP*2*x200-(b_CMP*2+a_CMP_GMP*2+a_CMP_MEP*2+g_CMP*2)*x207;
xdot(208) =+b_CMP*2*(x207-x208);
xdot(209) =+b_CMP*2*(x208-x209);
xdot(210) =a_CMP_GMP*2*(x207-x210);
xdot(211) =a_CMP_GMP*2*(x210-x211);
xdot(212) =a_CMP_MEP*2*(x207-x212);
xdot(213) =a_CMP_MEP*2*(x212-x213);
xdot(214) =g_CMP*2*(x207-x214);
xdot(215) =g_CMP*2*(x214-x215);
xdot(216) =a_MPP_CMP*2*x110+2*b_CMP*2*x209+2*b_CMP*2*x218-(b_CMP*2+a_CMP_GMP*2+a_CMP_MEP*2+g_CMP*2)*x216;
xdot(217) =+b_CMP*2*(x216-x217);
xdot(218) =+b_CMP*2*(x217-x218);
xdot(219) =a_CMP_GMP*2*(x216-x219);
xdot(220) =a_CMP_GMP*2*(x219-x220);
xdot(221) =a_CMP_MEP*2*(x216-x221);
xdot(222) =a_CMP_MEP*2*(x221-x222);
xdot(223) =g_CMP*2*(x216-x223);
xdot(224) =g_CMP*2*(x223-x224);

%GMP
xdot(225) =a_MLP_GMP*2*x119+a_CMP_GMP*2*x166-(b_GMP*2+a_GMP_mat*2+g_GMP*2)*x225;
...
xdot(232) =a_MLP_GMP*2*x126+a_CMP_GMP*2*x175+2*b_GMP*2*x227-(b_GMP*2+a_GMP_mat*2+g_GMP*2)*x232;
...
xdot(239) =a_MLP_GMP*2*x133+a_CMP_GMP*2*x184+2*b_GMP*2*x234-(b_GMP*2+a_GMP_mat*2+g_GMP*2)*x239;
...
xdot(246) =a_MLP_GMP*2*x140+a_CMP_GMP*2*x193+2*b_GMP*2*x241-(b_GMP*2+a_GMP_mat*2+g_GMP*2)*x246;
...
xdot(253) =a_MLP_GMP*2*x147+a_CMP_GMP*2*x202+2*b_GMP*2*x248-(b_GMP*2+a_GMP_mat*2+g_GMP*2)*x253;
...
xdot(260) =a_MLP_GMP*2*x154+a_CMP_GMP*2*x211+2*b_GMP*2*x255-(b_GMP*2+a_GMP_mat*2+g_GMP*2)*x260;
...
xdot(267) =a_MLP_GMP*2*x161+a_CMP_GMP*2*x220+2*b_GMP*2*x262+2*b_GMP*2*x269-(b_GMP*2+a_GMP_mat*2+g_GMP*2)*x267;
...
%MEP
xdot(274) =a_CMP_MEP*2*x168-(b_MEP*2+a_MEP_mat*2+g_MEP*2)*x274;
...
xdot(281) =a_CMP_MEP*2*x177+2*b_MEP*2*x276-(b_MEP*2+a_MEP_mat*2+g_MEP*2)*x281;
...
xdot(288) =a_CMP_MEP*2*x186+2*b_MEP*2*x283-(b_MEP*2+a_MEP_mat*2+g_MEP*2)*x288;
...
xdot(295) =a_CMP_MEP*2*x195+2*b_MEP*2*x290-(b_MEP*2+a_MEP_mat*2+g_MEP*2)*x295;
...
xdot(302) =a_CMP_MEP*2*x204+2*b_MEP*2*x297-(b_MEP*2+a_MEP_mat*2+g_MEP*2)*x302;
...
xdot(309) =a_CMP_MEP*2*x213+2*b_MEP*2*x304-(b_MEP*2+a_MEP_mat*2+g_MEP*2)*x309;
...
xdot(316) =a_CMP_MEP*2*x222+2*b_MEP*2*x311+2*b_MEP*2*x318-(b_MEP*2+a_MEP_mat*2+g_MEP*2)*x316;
...
% INITIAL CONDITIONS
x0 = sym(zeros(size(x)));
x0([1,50,113,162,225,274,323])=exp(p(1:7))-1;
...
for i=1:7
y(14+i) = log(sum(x((i-1)*7+113:i*7+113-1))+1);
end
for i=1:7
