...
%MPP
xdot(64) =a_HSC_MPP*2*x7-(b_MPP*2+a_MPP_CMP*2+a_MPP_MLP*2+g_MPP*2)*x64;
...
xdot(73) =a_HSC_MPP*2*x16+2*b_MPP*2*x66-(b_MPP*2+a_MPP_CMP*2+a_MPP_MLP*2+g_MPP*2)*x73;
...
xdot(82) =a_HSC_MPP*2*x25+2*b_MPP*2*x75-(b_MPP*2+a_MPP_CMP*2+a_MPP_MLP*2+g_MPP*2)*x82;
...
xdot(91) =a_HSC_MPP*2*x34+2*b_MPP*2*x84-(b_MPP*2+a_MPP_CMP*2+a_MPP_MLP*2+g_MPP*2)*x91;
...
xdot(100) =a_HSC_MPP*2*x43+2*b_MPP*2*x93-(b_MPP*2+a_MPP_CMP*2+a_MPP_MLP*2+g_MPP*2)*x100;
...
xdot(109) =a_HSC_MPP*2*x52+2*b_MPP*2*x102-(b_MPP*2+a_MPP_CMP*2+a_MPP_MLP*2+g_MPP*2)*x109;
...
xdot(118) =a_HSC_MPP*2*x61+2*b_MPP*2*x111+2*b_MPP*2*x120-(b_MPP*2+a_MPP_CMP*2+a_MPP_MLP*2+g_MPP*2)*x118;
...
%CMP
xdot(162) =a_MPP_CMP*2*x68-(b_CMP*2+a_CMP_GMP*2+g_CMP*2)*x162;
xdot(163) =+b_CMP*2*(x162-x163);
xdot(164) =+b_CMP*2*(x163-x164);
xdot(165) =a_CMP_GMP*2*(x162-x165);
xdot(166) =a_CMP_GMP*2*(x165-x166);
xdot(167) =g_CMP*2*(x162-x167);
xdot(168) =g_CMP*2*(x167-x168);
xdot(169) =a_MPP_CMP*2*x77+2*b_CMP*2*x164-(b_CMP*2+a_CMP_GMP*2+g_CMP*2)*x169;
xdot(170) =+b_CMP*2*(x169-x170);
xdot(171) =+b_CMP*2*(x170-x171);
xdot(172) =a_CMP_GMP*2*(x169-x172);
xdot(173) =a_CMP_GMP*2*(x172-x173);
xdot(174) =g_CMP*2*(x169-x174);
xdot(175) =g_CMP*2*(x174-x175);
xdot(176) =a_MPP_CMP*2*x86+2*b_CMP*2*x171-(b_CMP*2+a_CMP_GMP*2+g_CMP*2)*x176;
...
xdot(183) =a_MPP_CMP*2*x95+2*b_CMP*2*x178-(b_CMP*2+a_CMP_GMP*2+g_CMP*2)*x183;
...
xdot(190) =a_MPP_CMP*2*x104+2*b_CMP*2*x185-(b_CMP*2+a_CMP_GMP*2+g_CMP*2)*x190;
...
xdot(197) =a_MPP_CMP*2*x113+2*b_CMP*2*x192-(b_CMP*2+a_CMP_GMP*2+g_CMP*2)*x197;
...
xdot(204) =a_MPP_CMP*2*x122+2*b_CMP*2*x199+2*b_CMP*2*x206-(b_CMP*2+a_CMP_GMP*2+g_CMP*2)*x204;
...
%GMP
xdot(211) =a_CMP_GMP*2*x166-(b_GMP*2+a_GMP_mat*2+g_GMP*2)*x211;
...
xdot(218) =a_CMP_GMP*2*x173+2*b_GMP*2*x213-(b_GMP*2+a_GMP_mat*2+g_GMP*2)*x218;
...
xdot(225) =a_CMP_GMP*2*x180+2*b_GMP*2*x220-(b_GMP*2+a_GMP_mat*2+g_GMP*2)*x225;
...
xdot(232) =a_CMP_GMP*2*x187+2*b_GMP*2*x227-(b_GMP*2+a_GMP_mat*2+g_GMP*2)*x232;
...
xdot(239) =a_CMP_GMP*2*x194+2*b_GMP*2*x234-(b_GMP*2+a_GMP_mat*2+g_GMP*2)*x239;
...
xdot(246) =a_CMP_GMP*2*x201+2*b_GMP*2*x241-(b_GMP*2+a_GMP_mat*2+g_GMP*2)*x246;
...
xdot(253) =a_CMP_GMP*2*x208+2*b_GMP*2*x248+2*b_GMP*2*x255-(b_GMP*2+a_GMP_mat*2+g_GMP*2)*x253;
...
%MEP
xdot(260) =a_HSC_MEP*2*x5-(b_MEP*2+a_MEP_mat*2+g_MEP*2)*x260;
...
xdot(267) =a_HSC_MEP*2*x14+2*b_MEP*2*x262-(b_MEP*2+a_MEP_mat*2+g_MEP*2)*x267;
...
xdot(274) =a_HSC_MEP*2*x23+2*b_MEP*2*x269-(b_MEP*2+a_MEP_mat*2+g_MEP*2)*x274;
...
xdot(281) =a_HSC_MEP*2*x32+2*b_MEP*2*x276-(b_MEP*2+a_MEP_mat*2+g_MEP*2)*x281;
...
xdot(288) =a_HSC_MEP*2*x41+2*b_MEP*2*x283-(b_MEP*2+a_MEP_mat*2+g_MEP*2)*x288;
...
xdot(295) =a_HSC_MEP*2*x50+2*b_MEP*2*x290-(b_MEP*2+a_MEP_mat*2+g_MEP*2)*x295;
...
xdot(302) =a_HSC_MEP*2*x59+2*b_MEP*2*x297+2*b_MEP*2*x304-(b_MEP*2+a_MEP_mat*2+g_MEP*2)*x302;
...
% INITIAL CONDITIONS
x0 = sym(zeros(size(x)));
x0([1,64,127,162,211,260,309])=exp(p(1:7))-1;
...
for i=1:7
y(21+i) = log(sum(x((i-1)*7+162:i*7+162-1))+1);
end
for i=1:7
