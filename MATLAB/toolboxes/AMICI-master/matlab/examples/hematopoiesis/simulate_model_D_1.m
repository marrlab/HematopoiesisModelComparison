% simulate_model_D_1.m is the matlab interface to the cvodes mex
...
% USAGE:
% ======
% [...] = simulate_model_D_1(tout,theta)
% [...] = simulate_model_D_1(tout,theta,kappa,data,options)
% [status,tout,x,y,sx,sy] = simulate_model_D_1(...)
%
% INPUTS:
% =======
...
function varargout = simulate_model_D_1(varargin)
...
sol = ami_model_D_1(tout,theta(1:29),kappa(1:0),options_ami,plist,xscale,init,data);
if(nargout>1)
