...
%CMP
xdot(253) =a_MPP_CMP*3*x98-(b_CMP*3+a_CMP_MEP*3+a_CMP_GMP*3+g_CMP*3)*x253;
...
xdot(266) =a_MPP_CMP*3*x111+2*b_CMP*3*x256-(b_CMP*3+a_CMP_MEP*3+a_CMP_GMP*3+g_CMP*3)*x266;
...
xdot(279) =a_MPP_CMP*3*x124+2*b_CMP*3*x269-(b_CMP*3+a_CMP_MEP*3+a_CMP_GMP*3+g_CMP*3)*x279;
...
xdot(292) =a_MPP_CMP*3*x137+2*b_CMP*3*x282-(b_CMP*3+a_CMP_MEP*3+a_CMP_GMP*3+g_CMP*3)*x292;
...
xdot(305) =a_MPP_CMP*3*x150+2*b_CMP*3*x295-(b_CMP*3+a_CMP_MEP*3+a_CMP_GMP*3+g_CMP*3)*x305;
...
xdot(318) =a_MPP_CMP*3*x163+2*b_CMP*3*x308-(b_CMP*3+a_CMP_MEP*3+a_CMP_GMP*3+g_CMP*3)*x318;
...
xdot(331) =a_MPP_CMP*3*x176+2*b_CMP*3*x321+2*b_CMP*3*x334-(b_CMP*3+a_CMP_MEP*3+a_CMP_GMP*3+g_CMP*3)*x331;
...
%GMP
xdot(344) =a_CMP_GMP*3*x262+a_MLP_GMP*3*x192-(b_GMP*3+a_GMP_mat*3+g_GMP*3)*x344;
...
xdot(354) =a_CMP_GMP*3*x275+a_MLP_GMP*3*x202+2*b_GMP*3*x347-(b_GMP*3+a_GMP_mat*3+g_GMP*3)*x354;
...
xdot(364) =a_CMP_GMP*3*x288+a_MLP_GMP*3*x212+2*b_GMP*3*x357-(b_GMP*3+a_GMP_mat*3+g_GMP*3)*x364;
...
xdot(374) =a_CMP_GMP*3*x301+a_MLP_GMP*3*x222+2*b_GMP*3*x367-(b_GMP*3+a_GMP_mat*3+g_GMP*3)*x374;
...
xdot(384) =a_CMP_GMP*3*x314+a_MLP_GMP*3*x232+2*b_GMP*3*x377-(b_GMP*3+a_GMP_mat*3+g_GMP*3)*x384;
...
xdot(394) =a_CMP_GMP*3*x327+a_MLP_GMP*3*x242+2*b_GMP*3*x387-(b_GMP*3+a_GMP_mat*3+g_GMP*3)*x394;
...
xdot(404) =a_CMP_GMP*3*x340+a_MLP_GMP*3*x252+2*b_GMP*3*x397+2*b_GMP*3*x407-(b_GMP*3+a_GMP_mat*3+g_GMP*3)*x404;
...
%MEP
xdot(414) =a_CMP_MEP*3*x259-(b_MEP*3+a_MEP_mat*3+g_MEP*3)*x414;
...
xdot(424) =a_CMP_MEP*3*x272+2*b_MEP*3*x417-(b_MEP*3+a_MEP_mat*3+g_MEP*3)*x424;
...
xdot(434) =a_CMP_MEP*3*x285+2*b_MEP*3*x427-(b_MEP*3+a_MEP_mat*3+g_MEP*3)*x434;
...
xdot(444) =a_CMP_MEP*3*x298+2*b_MEP*3*x437-(b_MEP*3+a_MEP_mat*3+g_MEP*3)*x444;
...
xdot(454) =a_CMP_MEP*3*x311+2*b_MEP*3*x447-(b_MEP*3+a_MEP_mat*3+g_MEP*3)*x454;
...
xdot(464) =a_CMP_MEP*3*x324+2*b_MEP*3*x457-(b_MEP*3+a_MEP_mat*3+g_MEP*3)*x464;
...
xdot(474) =a_CMP_MEP*3*x337+2*b_MEP*3*x467+2*b_MEP*3*x477-(b_MEP*3+a_MEP_mat*3+g_MEP*3)*x474;
...
%mat
xdot(484) =a_HSC_mat*3*x10+a_MEP_mat*3*x420+a_GMP_mat*3*x350-(b_mat*3+g_mat*3)*x484;
...
xdot(491) =a_HSC_mat*3*x23+a_MEP_mat*3*x430+a_GMP_mat*3*x360+2*b_mat*3*x487-(b_mat*3+g_mat*3)*x491;
...
xdot(498) =a_HSC_mat*3*x36+a_MEP_mat*3*x440+a_GMP_mat*3*x370+2*b_mat*3*x494-(b_mat*3+g_mat*3)*x498;
...
xdot(505) =a_HSC_mat*3*x49+a_MEP_mat*3*x450+a_GMP_mat*3*x380+2*b_mat*3*x501-(b_mat*3+g_mat*3)*x505;
...
xdot(512) =a_HSC_mat*3*x62+a_MEP_mat*3*x460+a_GMP_mat*3*x390+2*b_mat*3*x508-(b_mat*3+g_mat*3)*x512;
...
xdot(519) =a_HSC_mat*3*x75+a_MEP_mat*3*x470+a_GMP_mat*3*x400+2*b_mat*3*x515-(b_mat*3+g_mat*3)*x519;
...
xdot(526) =a_HSC_mat*3*x88+a_MEP_mat*3*x480+a_GMP_mat*3*x410+2*b_mat*3*x522+2*b_mat*3*x529-(b_mat*3+g_mat*3)*x526;
...
% INITIAL CONDITIONS
x0 = sym(zeros(size(x)));
x0([1,92,183,253,344,414,484])=exp(p(1:7))-1;
