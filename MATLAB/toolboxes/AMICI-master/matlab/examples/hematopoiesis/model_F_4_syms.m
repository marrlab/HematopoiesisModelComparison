...
syms x0_1 x0_2 x0_3 x0_4 x0_5 x0_6 x0_7 a_HSC_CMP a_HSC_MPP b_HSC g_HSC a_CMP_MEP a_CMP_GMP b_CMP g_CMP a_MPP_GMP a_MPP_MLP b_MPP g_MPP a_MLP b_MLP a_MEP_mat b_MEP g_MEP a_GMP_mat b_GMP g_GMP b_mat g_mat

% create parameter vector 
p= [x0_1 x0_2 x0_3 x0_4 x0_5 x0_6 x0_7 a_HSC_CMP a_HSC_MPP b_HSC g_HSC a_CMP_MEP a_CMP_GMP b_CMP g_CMP a_MPP_GMP a_MPP_MLP b_MPP g_MPP a_MLP b_MLP a_MEP_mat b_MEP g_MEP a_GMP_mat b_GMP g_GMP b_mat g_mat];
...
%MPP
xdot(120) =a_HSC_MPP*4*x13-(b_MPP*4+a_MPP_GMP*4+a_MPP_MLP*4+g_MPP*4)*x120;
...
xdot(137) =a_HSC_MPP*4*x30+2*b_MPP*4*x124-(b_MPP*4+a_MPP_GMP*4+a_MPP_MLP*4+g_MPP*4)*x137;
xdot(138) =+b_MPP*4*(x137-x138);
xdot(139) =+b_MPP*4*(x138-x139);
xdot(140) =+b_MPP*4*(x139-x140);
xdot(141) =+b_MPP*4*(x140-x141);
xdot(142) =a_MPP_GMP*4*(x137-x142);
xdot(143) =a_MPP_GMP*4*(x142-x143);
xdot(144) =a_MPP_GMP*4*(x143-x144);
xdot(145) =a_MPP_GMP*4*(x144-x145);
...
xdot(154) =a_HSC_MPP*4*x47+2*b_MPP*4*x141-(b_MPP*4+a_MPP_GMP*4+a_MPP_MLP*4+g_MPP*4)*x154;
xdot(155) =+b_MPP*4*(x154-x155);
xdot(156) =+b_MPP*4*(x155-x156);
xdot(157) =+b_MPP*4*(x156-x157);
xdot(158) =+b_MPP*4*(x157-x158);
xdot(159) =a_MPP_GMP*4*(x154-x159);
xdot(160) =a_MPP_GMP*4*(x159-x160);
xdot(161) =a_MPP_GMP*4*(x160-x161);
xdot(162) =a_MPP_GMP*4*(x161-x162);
...
xdot(171) =a_HSC_MPP*4*x64+2*b_MPP*4*x158-(b_MPP*4+a_MPP_GMP*4+a_MPP_MLP*4+g_MPP*4)*x171;
xdot(172) =+b_MPP*4*(x171-x172);
xdot(173) =+b_MPP*4*(x172-x173);
xdot(174) =+b_MPP*4*(x173-x174);
xdot(175) =+b_MPP*4*(x174-x175);
xdot(176) =a_MPP_GMP*4*(x171-x176);
xdot(177) =a_MPP_GMP*4*(x176-x177);
xdot(178) =a_MPP_GMP*4*(x177-x178);
xdot(179) =a_MPP_GMP*4*(x178-x179);
...
xdot(188) =a_HSC_MPP*4*x81+2*b_MPP*4*x175-(b_MPP*4+a_MPP_GMP*4+a_MPP_MLP*4+g_MPP*4)*x188;
xdot(189) =+b_MPP*4*(x188-x189);
xdot(190) =+b_MPP*4*(x189-x190);
xdot(191) =+b_MPP*4*(x190-x191);
xdot(192) =+b_MPP*4*(x191-x192);
xdot(193) =a_MPP_GMP*4*(x188-x193);
xdot(194) =a_MPP_GMP*4*(x193-x194);
xdot(195) =a_MPP_GMP*4*(x194-x195);
xdot(196) =a_MPP_GMP*4*(x195-x196);
...
xdot(222) =a_HSC_MPP*4*x115+2*b_MPP*4*x209+2*b_MPP*4*x226-(b_MPP*4+a_MPP_GMP*4+a_MPP_MLP*4+g_MPP*4)*x222;
xdot(223) =+b_MPP*4*(x222-x223);
xdot(224) =+b_MPP*4*(x223-x224);
xdot(225) =+b_MPP*4*(x224-x225);
xdot(226) =+b_MPP*4*(x225-x226);
xdot(227) =a_MPP_GMP*4*(x222-x227);
xdot(228) =a_MPP_GMP*4*(x227-x228);
xdot(229) =a_MPP_GMP*4*(x228-x229);
xdot(230) =a_MPP_GMP*4*(x229-x230);
...
%CMP
xdot(302) =a_HSC_CMP*4*x9-(b_CMP*4+a_CMP_MEP*4+a_CMP_GMP*4+g_CMP*4)*x302;
...
xdot(319) =a_HSC_CMP*4*x26+2*b_CMP*4*x306-(b_CMP*4+a_CMP_MEP*4+a_CMP_GMP*4+g_CMP*4)*x319;
...
xdot(336) =a_HSC_CMP*4*x43+2*b_CMP*4*x323-(b_CMP*4+a_CMP_MEP*4+a_CMP_GMP*4+g_CMP*4)*x336;
...
xdot(353) =a_HSC_CMP*4*x60+2*b_CMP*4*x340-(b_CMP*4+a_CMP_MEP*4+a_CMP_GMP*4+g_CMP*4)*x353;
...
xdot(370) =a_HSC_CMP*4*x77+2*b_CMP*4*x357-(b_CMP*4+a_CMP_MEP*4+a_CMP_GMP*4+g_CMP*4)*x370;
...
xdot(387) =a_HSC_CMP*4*x94+2*b_CMP*4*x374-(b_CMP*4+a_CMP_MEP*4+a_CMP_GMP*4+g_CMP*4)*x387;
...
xdot(404) =a_HSC_CMP*4*x111+2*b_CMP*4*x391+2*b_CMP*4*x408-(b_CMP*4+a_CMP_MEP*4+a_CMP_GMP*4+g_CMP*4)*x404;
...
%GMP
xdot(421) =a_CMP_GMP*4*x314+a_MPP_GMP*4*x128-(b_GMP*4+a_GMP_mat*4+g_GMP*4)*x421;
...
xdot(434) =a_CMP_GMP*4*x331+a_MPP_GMP*4*x145+2*b_GMP*4*x425-(b_GMP*4+a_GMP_mat*4+g_GMP*4)*x434;
...
xdot(447) =a_CMP_GMP*4*x348+a_MPP_GMP*4*x162+2*b_GMP*4*x438-(b_GMP*4+a_GMP_mat*4+g_GMP*4)*x447;
...
xdot(460) =a_CMP_GMP*4*x365+a_MPP_GMP*4*x179+2*b_GMP*4*x451-(b_GMP*4+a_GMP_mat*4+g_GMP*4)*x460;
...
xdot(473) =a_CMP_GMP*4*x382+a_MPP_GMP*4*x196+2*b_GMP*4*x464-(b_GMP*4+a_GMP_mat*4+g_GMP*4)*x473;
...
xdot(486) =a_CMP_GMP*4*x399+a_MPP_GMP*4*x213+2*b_GMP*4*x477-(b_GMP*4+a_GMP_mat*4+g_GMP*4)*x486;
...
xdot(499) =a_CMP_GMP*4*x416+a_MPP_GMP*4*x230+2*b_GMP*4*x490+2*b_GMP*4*x503-(b_GMP*4+a_GMP_mat*4+g_GMP*4)*x499;
