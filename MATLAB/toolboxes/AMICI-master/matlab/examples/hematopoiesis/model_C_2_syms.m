...
%CMP
xdot(176) =a_MPP_CMP*2*x68-(b_CMP*2+a_CMP_MEP*2+a_CMP_GMP*2+g_CMP*2)*x176;
...
xdot(185) =a_MPP_CMP*2*x77+2*b_CMP*2*x178-(b_CMP*2+a_CMP_MEP*2+a_CMP_GMP*2+g_CMP*2)*x185;
...
xdot(194) =a_MPP_CMP*2*x86+2*b_CMP*2*x187-(b_CMP*2+a_CMP_MEP*2+a_CMP_GMP*2+g_CMP*2)*x194;
...
xdot(203) =a_MPP_CMP*2*x95+2*b_CMP*2*x196-(b_CMP*2+a_CMP_MEP*2+a_CMP_GMP*2+g_CMP*2)*x203;
...
xdot(212) =a_MPP_CMP*2*x104+2*b_CMP*2*x205-(b_CMP*2+a_CMP_MEP*2+a_CMP_GMP*2+g_CMP*2)*x212;
...
xdot(221) =a_MPP_CMP*2*x113+2*b_CMP*2*x214-(b_CMP*2+a_CMP_MEP*2+a_CMP_GMP*2+g_CMP*2)*x221;
...
xdot(230) =a_MPP_CMP*2*x122+2*b_CMP*2*x223+2*b_CMP*2*x232-(b_CMP*2+a_CMP_MEP*2+a_CMP_GMP*2+g_CMP*2)*x230;
...
%GMP
xdot(239) =a_CMP_GMP*2*x182+a_MLP_GMP*2*x133-(b_GMP*2+a_GMP_mat*2+g_GMP*2)*x239;
...
xdot(246) =a_CMP_GMP*2*x191+a_MLP_GMP*2*x140+2*b_GMP*2*x241-(b_GMP*2+a_GMP_mat*2+g_GMP*2)*x246;
...
xdot(253) =a_CMP_GMP*2*x200+a_MLP_GMP*2*x147+2*b_GMP*2*x248-(b_GMP*2+a_GMP_mat*2+g_GMP*2)*x253;
...
xdot(260) =a_CMP_GMP*2*x209+a_MLP_GMP*2*x154+2*b_GMP*2*x255-(b_GMP*2+a_GMP_mat*2+g_GMP*2)*x260;
...
xdot(267) =a_CMP_GMP*2*x218+a_MLP_GMP*2*x161+2*b_GMP*2*x262-(b_GMP*2+a_GMP_mat*2+g_GMP*2)*x267;
...
xdot(274) =a_CMP_GMP*2*x227+a_MLP_GMP*2*x168+2*b_GMP*2*x269-(b_GMP*2+a_GMP_mat*2+g_GMP*2)*x274;
...
xdot(281) =a_CMP_GMP*2*x236+a_MLP_GMP*2*x175+2*b_GMP*2*x276+2*b_GMP*2*x283-(b_GMP*2+a_GMP_mat*2+g_GMP*2)*x281;
...
%MEP
xdot(288) =a_CMP_MEP*2*x180-(b_MEP*2+a_MEP_mat*2+g_MEP*2)*x288;
...
xdot(295) =a_CMP_MEP*2*x189+2*b_MEP*2*x290-(b_MEP*2+a_MEP_mat*2+g_MEP*2)*x295;
...
xdot(302) =a_CMP_MEP*2*x198+2*b_MEP*2*x297-(b_MEP*2+a_MEP_mat*2+g_MEP*2)*x302;
...
xdot(309) =a_CMP_MEP*2*x207+2*b_MEP*2*x304-(b_MEP*2+a_MEP_mat*2+g_MEP*2)*x309;
...
xdot(316) =a_CMP_MEP*2*x216+2*b_MEP*2*x311-(b_MEP*2+a_MEP_mat*2+g_MEP*2)*x316;
...
xdot(323) =a_CMP_MEP*2*x225+2*b_MEP*2*x318-(b_MEP*2+a_MEP_mat*2+g_MEP*2)*x323;
...
xdot(330) =a_CMP_MEP*2*x234+2*b_MEP*2*x325+2*b_MEP*2*x332-(b_MEP*2+a_MEP_mat*2+g_MEP*2)*x330;
...
%mat
xdot(337) =a_HSC_mat*2*x7+a_MEP_mat*2*x292+a_GMP_mat*2*x243-(b_mat*2+g_mat*2)*x337;
xdot(338) =+b_mat*2*(x337-x338);
xdot(339) =+b_mat*2*(x338-x339);
xdot(340) =g_mat*2*(x337-x340);
xdot(341) =g_mat*2*(x340-x341);
xdot(342) =a_HSC_mat*2*x16+a_MEP_mat*2*x299+a_GMP_mat*2*x250+2*b_mat*2*x339-(b_mat*2+g_mat*2)*x342;
xdot(343) =+b_mat*2*(x342-x343);
xdot(344) =+b_mat*2*(x343-x344);
xdot(345) =g_mat*2*(x342-x345);
xdot(346) =g_mat*2*(x345-x346);
xdot(347) =a_HSC_mat*2*x25+a_MEP_mat*2*x306+a_GMP_mat*2*x257+2*b_mat*2*x344-(b_mat*2+g_mat*2)*x347;
xdot(348) =+b_mat*2*(x347-x348);
xdot(349) =+b_mat*2*(x348-x349);
xdot(350) =g_mat*2*(x347-x350);
xdot(351) =g_mat*2*(x350-x351);
xdot(352) =a_HSC_mat*2*x34+a_MEP_mat*2*x313+a_GMP_mat*2*x264+2*b_mat*2*x349-(b_mat*2+g_mat*2)*x352;
xdot(353) =+b_mat*2*(x352-x353);
xdot(354) =+b_mat*2*(x353-x354);
xdot(355) =g_mat*2*(x352-x355);
xdot(356) =g_mat*2*(x355-x356);
xdot(357) =a_HSC_mat*2*x43+a_MEP_mat*2*x320+a_GMP_mat*2*x271+2*b_mat*2*x354-(b_mat*2+g_mat*2)*x357;
xdot(358) =+b_mat*2*(x357-x358);
xdot(359) =+b_mat*2*(x358-x359);
xdot(360) =g_mat*2*(x357-x360);
xdot(361) =g_mat*2*(x360-x361);
xdot(362) =a_HSC_mat*2*x52+a_MEP_mat*2*x327+a_GMP_mat*2*x278+2*b_mat*2*x359-(b_mat*2+g_mat*2)*x362;
xdot(363) =+b_mat*2*(x362-x363);
xdot(364) =+b_mat*2*(x363-x364);
xdot(365) =g_mat*2*(x362-x365);
xdot(366) =g_mat*2*(x365-x366);
xdot(367) =a_HSC_mat*2*x61+a_MEP_mat*2*x334+a_GMP_mat*2*x285+2*b_mat*2*x364+2*b_mat*2*x369-(b_mat*2+g_mat*2)*x367;
...
% INITIAL CONDITIONS
x0 = sym(zeros(size(x)));
x0([1,64,127,176,239,288,337])=exp(p(1:7))-1;
