...
%MLP
xdot(162) =a_MPP_MLP/3*x77-(b_MLP/3+a_MLP/3+a_MLP_GMP/3)*x162;
...
xdot(169) =a_MLP_GMP/3*(x162-x169);
xdot(170) =a_MLP_GMP/3*(x169-x170);
xdot(171) =a_MLP_GMP/3*(x170-x171);
xdot(172) =a_MPP_MLP/3*x90+2*b_MLP/3*x165-(b_MLP/3+a_MLP/3+a_MLP_GMP/3)*x172;
xdot(173) =+b_MLP/3*(x172-x173);
xdot(174) =+b_MLP/3*(x173-x174);
xdot(175) =+b_MLP/3*(x174-x175);
xdot(176) =a_MLP/3*(x172-x176);
xdot(177) =a_MLP/3*(x176-x177);
xdot(178) =a_MLP/3*(x177-x178);
xdot(179) =a_MLP_GMP/3*(x172-x179);
xdot(180) =a_MLP_GMP/3*(x179-x180);
xdot(181) =a_MLP_GMP/3*(x180-x181);
xdot(182) =a_MPP_MLP/3*x103+2*b_MLP/3*x175-(b_MLP/3+a_MLP/3+a_MLP_GMP/3)*x182;
xdot(183) =+b_MLP/3*(x182-x183);
xdot(184) =+b_MLP/3*(x183-x184);
xdot(185) =+b_MLP/3*(x184-x185);
xdot(186) =a_MLP/3*(x182-x186);
xdot(187) =a_MLP/3*(x186-x187);
xdot(188) =a_MLP/3*(x187-x188);
xdot(189) =a_MLP_GMP/3*(x182-x189);
xdot(190) =a_MLP_GMP/3*(x189-x190);
xdot(191) =a_MLP_GMP/3*(x190-x191);
xdot(192) =a_MPP_MLP/3*x116+2*b_MLP/3*x185-(b_MLP/3+a_MLP/3+a_MLP_GMP/3)*x192;
xdot(193) =+b_MLP/3*(x192-x193);
xdot(194) =+b_MLP/3*(x193-x194);
xdot(195) =+b_MLP/3*(x194-x195);
xdot(196) =a_MLP/3*(x192-x196);
xdot(197) =a_MLP/3*(x196-x197);
xdot(198) =a_MLP/3*(x197-x198);
xdot(199) =a_MLP_GMP/3*(x192-x199);
xdot(200) =a_MLP_GMP/3*(x199-x200);
xdot(201) =a_MLP_GMP/3*(x200-x201);
xdot(202) =a_MPP_MLP/3*x129+2*b_MLP/3*x195-(b_MLP/3+a_MLP/3+a_MLP_GMP/3)*x202;
xdot(203) =+b_MLP/3*(x202-x203);
xdot(204) =+b_MLP/3*(x203-x204);
xdot(205) =+b_MLP/3*(x204-x205);
xdot(206) =a_MLP/3*(x202-x206);
xdot(207) =a_MLP/3*(x206-x207);
xdot(208) =a_MLP/3*(x207-x208);
xdot(209) =a_MLP_GMP/3*(x202-x209);
xdot(210) =a_MLP_GMP/3*(x209-x210);
xdot(211) =a_MLP_GMP/3*(x210-x211);
xdot(212) =a_MPP_MLP/3*x142+2*b_MLP/3*x205-(b_MLP/3+a_MLP/3+a_MLP_GMP/3)*x212;
xdot(213) =+b_MLP/3*(x212-x213);
xdot(214) =+b_MLP/3*(x213-x214);
xdot(215) =+b_MLP/3*(x214-x215);
xdot(216) =a_MLP/3*(x212-x216);
xdot(217) =a_MLP/3*(x216-x217);
xdot(218) =a_MLP/3*(x217-x218);
xdot(219) =a_MLP_GMP/3*(x212-x219);
xdot(220) =a_MLP_GMP/3*(x219-x220);
xdot(221) =a_MLP_GMP/3*(x220-x221);
xdot(222) =a_MPP_MLP/3*x155+2*b_MLP/3*x215+2*b_MLP/3*x225-(b_MLP/3+a_MLP/3+a_MLP_GMP/3)*x222;
xdot(223) =+b_MLP/3*(x222-x223);
xdot(224) =+b_MLP/3*(x223-x224);
xdot(225) =+b_MLP/3*(x224-x225);
xdot(226) =a_MLP/3*(x222-x226);
xdot(227) =a_MLP/3*(x226-x227);
xdot(228) =a_MLP/3*(x227-x228);
xdot(229) =a_MLP_GMP/3*(x222-x229);
xdot(230) =a_MLP_GMP/3*(x229-x230);
xdot(231) =a_MLP_GMP/3*(x230-x231);

%CMP
xdot(232) =a_MPP_CMP/3*x80-(b_CMP/3+a_CMP_GMP/3+a_CMP_MEP/3+g_CMP/3)*x232;
xdot(233) =+b_CMP/3*(x232-x233);
xdot(234) =+b_CMP/3*(x233-x234);
xdot(235) =+b_CMP/3*(x234-x235);
xdot(236) =a_CMP_GMP/3*(x232-x236);
xdot(237) =a_CMP_GMP/3*(x236-x237);
xdot(238) =a_CMP_GMP/3*(x237-x238);
xdot(239) =a_CMP_MEP/3*(x232-x239);
xdot(240) =a_CMP_MEP/3*(x239-x240);
xdot(241) =a_CMP_MEP/3*(x240-x241);
xdot(242) =g_CMP/3*(x232-x242);
xdot(243) =g_CMP/3*(x242-x243);
xdot(244) =g_CMP/3*(x243-x244);
xdot(245) =a_MPP_CMP/3*x93+2*b_CMP/3*x235-(b_CMP/3+a_CMP_GMP/3+a_CMP_MEP/3+g_CMP/3)*x245;
xdot(246) =+b_CMP/3*(x245-x246);
xdot(247) =+b_CMP/3*(x246-x247);
xdot(248) =+b_CMP/3*(x247-x248);
xdot(249) =a_CMP_GMP/3*(x245-x249);
xdot(250) =a_CMP_GMP/3*(x249-x250);
xdot(251) =a_CMP_GMP/3*(x250-x251);
xdot(252) =a_CMP_MEP/3*(x245-x252);
xdot(253) =a_CMP_MEP/3*(x252-x253);
xdot(254) =a_CMP_MEP/3*(x253-x254);
xdot(255) =g_CMP/3*(x245-x255);
xdot(256) =g_CMP/3*(x255-x256);
xdot(257) =g_CMP/3*(x256-x257);
xdot(258) =a_MPP_CMP/3*x106+2*b_CMP/3*x248-(b_CMP/3+a_CMP_GMP/3+a_CMP_MEP/3+g_CMP/3)*x258;
xdot(259) =+b_CMP/3*(x258-x259);
xdot(260) =+b_CMP/3*(x259-x260);
xdot(261) =+b_CMP/3*(x260-x261);
xdot(262) =a_CMP_GMP/3*(x258-x262);
xdot(263) =a_CMP_GMP/3*(x262-x263);
xdot(264) =a_CMP_GMP/3*(x263-x264);
xdot(265) =a_CMP_MEP/3*(x258-x265);
xdot(266) =a_CMP_MEP/3*(x265-x266);
xdot(267) =a_CMP_MEP/3*(x266-x267);
xdot(268) =g_CMP/3*(x258-x268);
xdot(269) =g_CMP/3*(x268-x269);
xdot(270) =g_CMP/3*(x269-x270);
xdot(271) =a_MPP_CMP/3*x119+2*b_CMP/3*x261-(b_CMP/3+a_CMP_GMP/3+a_CMP_MEP/3+g_CMP/3)*x271;
xdot(272) =+b_CMP/3*(x271-x272);
xdot(273) =+b_CMP/3*(x272-x273);
xdot(274) =+b_CMP/3*(x273-x274);
xdot(275) =a_CMP_GMP/3*(x271-x275);
xdot(276) =a_CMP_GMP/3*(x275-x276);
xdot(277) =a_CMP_GMP/3*(x276-x277);
xdot(278) =a_CMP_MEP/3*(x271-x278);
xdot(279) =a_CMP_MEP/3*(x278-x279);
xdot(280) =a_CMP_MEP/3*(x279-x280);
xdot(281) =g_CMP/3*(x271-x281);
xdot(282) =g_CMP/3*(x281-x282);
xdot(283) =g_CMP/3*(x282-x283);
xdot(284) =a_MPP_CMP/3*x132+2*b_CMP/3*x274-(b_CMP/3+a_CMP_GMP/3+a_CMP_MEP/3+g_CMP/3)*x284;
xdot(285) =+b_CMP/3*(x284-x285);
xdot(286) =+b_CMP/3*(x285-x286);
xdot(287) =+b_CMP/3*(x286-x287);
xdot(288) =a_CMP_GMP/3*(x284-x288);
xdot(289) =a_CMP_GMP/3*(x288-x289);
xdot(290) =a_CMP_GMP/3*(x289-x290);
xdot(291) =a_CMP_MEP/3*(x284-x291);
xdot(292) =a_CMP_MEP/3*(x291-x292);
xdot(293) =a_CMP_MEP/3*(x292-x293);
xdot(294) =g_CMP/3*(x284-x294);
xdot(295) =g_CMP/3*(x294-x295);
xdot(296) =g_CMP/3*(x295-x296);
xdot(297) =a_MPP_CMP/3*x145+2*b_CMP/3*x287-(b_CMP/3+a_CMP_GMP/3+a_CMP_MEP/3+g_CMP/3)*x297;
xdot(298) =+b_CMP/3*(x297-x298);
xdot(299) =+b_CMP/3*(x298-x299);
xdot(300) =+b_CMP/3*(x299-x300);
xdot(301) =a_CMP_GMP/3*(x297-x301);
xdot(302) =a_CMP_GMP/3*(x301-x302);
xdot(303) =a_CMP_GMP/3*(x302-x303);
xdot(304) =a_CMP_MEP/3*(x297-x304);
xdot(305) =a_CMP_MEP/3*(x304-x305);
xdot(306) =a_CMP_MEP/3*(x305-x306);
xdot(307) =g_CMP/3*(x297-x307);
xdot(308) =g_CMP/3*(x307-x308);
xdot(309) =g_CMP/3*(x308-x309);
xdot(310) =a_MPP_CMP/3*x158+2*b_CMP/3*x300+2*b_CMP/3*x313-(b_CMP/3+a_CMP_GMP/3+a_CMP_MEP/3+g_CMP/3)*x310;
xdot(311) =+b_CMP/3*(x310-x311);
xdot(312) =+b_CMP/3*(x311-x312);
xdot(313) =+b_CMP/3*(x312-x313);
xdot(314) =a_CMP_GMP/3*(x310-x314);
xdot(315) =a_CMP_GMP/3*(x314-x315);
xdot(316) =a_CMP_GMP/3*(x315-x316);
xdot(317) =a_CMP_MEP/3*(x310-x317);
xdot(318) =a_CMP_MEP/3*(x317-x318);
xdot(319) =a_CMP_MEP/3*(x318-x319);
xdot(320) =g_CMP/3*(x310-x320);
xdot(321) =g_CMP/3*(x320-x321);
xdot(322) =g_CMP/3*(x321-x322);

%GMP
xdot(323) =a_MLP_GMP/3*x171+a_CMP_GMP/3*x238-(b_GMP/3+a_GMP_mat/3+g_GMP/3)*x323;
...
xdot(333) =a_MLP_GMP/3*x181+a_CMP_GMP/3*x251+2*b_GMP/3*x326-(b_GMP/3+a_GMP_mat/3+g_GMP/3)*x333;
...
xdot(343) =a_MLP_GMP/3*x191+a_CMP_GMP/3*x264+2*b_GMP/3*x336-(b_GMP/3+a_GMP_mat/3+g_GMP/3)*x343;
...
xdot(353) =a_MLP_GMP/3*x201+a_CMP_GMP/3*x277+2*b_GMP/3*x346-(b_GMP/3+a_GMP_mat/3+g_GMP/3)*x353;
...
xdot(363) =a_MLP_GMP/3*x211+a_CMP_GMP/3*x290+2*b_GMP/3*x356-(b_GMP/3+a_GMP_mat/3+g_GMP/3)*x363;
...
xdot(373) =a_MLP_GMP/3*x221+a_CMP_GMP/3*x303+2*b_GMP/3*x366-(b_GMP/3+a_GMP_mat/3+g_GMP/3)*x373;
...
xdot(383) =a_MLP_GMP/3*x231+a_CMP_GMP/3*x316+2*b_GMP/3*x376+2*b_GMP/3*x386-(b_GMP/3+a_GMP_mat/3+g_GMP/3)*x383;
...
%MEP
xdot(393) =a_CMP_MEP/3*x241-(b_MEP/3+a_MEP_mat/3+g_MEP/3)*x393;
...
xdot(403) =a_CMP_MEP/3*x254+2*b_MEP/3*x396-(b_MEP/3+a_MEP_mat/3+g_MEP/3)*x403;
...
xdot(413) =a_CMP_MEP/3*x267+2*b_MEP/3*x406-(b_MEP/3+a_MEP_mat/3+g_MEP/3)*x413;
...
xdot(423) =a_CMP_MEP/3*x280+2*b_MEP/3*x416-(b_MEP/3+a_MEP_mat/3+g_MEP/3)*x423;
...
xdot(433) =a_CMP_MEP/3*x293+2*b_MEP/3*x426-(b_MEP/3+a_MEP_mat/3+g_MEP/3)*x433;
...
xdot(443) =a_CMP_MEP/3*x306+2*b_MEP/3*x436-(b_MEP/3+a_MEP_mat/3+g_MEP/3)*x443;
...
xdot(453) =a_CMP_MEP/3*x319+2*b_MEP/3*x446+2*b_MEP/3*x456-(b_MEP/3+a_MEP_mat/3+g_MEP/3)*x453;
...
%mat
xdot(463) =a_GMP_mat/3*x329+a_MEP_mat/3*x399-(b_mat/3+g_mat/3)*x463;
...
xdot(470) =a_GMP_mat/3*x339+a_MEP_mat/3*x409+2*b_mat/3*x466-(b_mat/3+g_mat/3)*x470;
...
xdot(477) =a_GMP_mat/3*x349+a_MEP_mat/3*x419+2*b_mat/3*x473-(b_mat/3+g_mat/3)*x477;
...
xdot(484) =a_GMP_mat/3*x359+a_MEP_mat/3*x429+2*b_mat/3*x480-(b_mat/3+g_mat/3)*x484;
...
xdot(491) =a_GMP_mat/3*x369+a_MEP_mat/3*x439+2*b_mat/3*x487-(b_mat/3+g_mat/3)*x491;
...
xdot(498) =a_GMP_mat/3*x379+a_MEP_mat/3*x449+2*b_mat/3*x494-(b_mat/3+g_mat/3)*x498;
...
xdot(505) =a_GMP_mat/3*x389+a_MEP_mat/3*x459+2*b_mat/3*x501+2*b_mat/3*x508-(b_mat/3+g_mat/3)*x505;
...
% INITIAL CONDITIONS
x0 = sym(zeros(size(x)));
x0([1,71,162,232,323,393,463])=exp(p(1:7))-1;
...
for i=1:7
y(14+i) = log(sum(x((i-1)*10+162:i*10+162-1))+1);
end
for i=1:7
y(21+i) = log(sum(x((i-1)*13+232:i*13+232-1))+1);
end
for i=1:7
