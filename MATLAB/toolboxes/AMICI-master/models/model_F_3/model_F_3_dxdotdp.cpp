...
void dxdotdp_model_F_3(realtype *dxdotdp, const realtype t, const realtype *x, const realtype *p, const realtype *k, const realtype *h, const int ip, const realtype *w, const realtype *dwdp) {
switch (ip) {
  case 7: {
  ...
  dxdotdp[231] = x[6]*3.0;
  dxdotdp[244] = x[19]*3.0;
  dxdotdp[257] = x[32]*3.0;
  dxdotdp[270] = x[45]*3.0;
  dxdotdp[283] = x[58]*3.0;
  dxdotdp[296] = x[71]*3.0;
  dxdotdp[309] = x[84]*3.0;
  ...
  dxdotdp[322] = x[97]*3.0;
  dxdotdp[332] = x[110]*3.0;
  dxdotdp[342] = x[123]*3.0;
  dxdotdp[352] = x[136]*3.0;
  dxdotdp[362] = x[149]*3.0;
  dxdotdp[372] = x[162]*3.0;
  dxdotdp[382] = x[175]*3.0;
