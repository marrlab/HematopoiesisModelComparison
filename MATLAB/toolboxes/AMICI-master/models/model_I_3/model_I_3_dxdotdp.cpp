...
void dxdotdp_model_I_3(realtype *dxdotdp, const realtype t, const realtype *x, const realtype *p, const realtype *k, const realtype *h, const int ip, const realtype *w, const realtype *dwdp) {
switch (ip) {
  case 7: {
  ...
  dxdotdp[91] = x[6]*3.0;
  dxdotdp[104] = x[19]*3.0;
  dxdotdp[117] = x[32]*3.0;
  dxdotdp[130] = x[45]*3.0;
  dxdotdp[143] = x[58]*3.0;
  dxdotdp[156] = x[71]*3.0;
  dxdotdp[169] = x[84]*3.0;
  ...
  dxdotdp[392] = x[9]*3.0;
  dxdotdp[402] = x[22]*3.0;
  dxdotdp[412] = x[35]*3.0;
  dxdotdp[422] = x[48]*3.0;
  dxdotdp[432] = x[61]*3.0;
  dxdotdp[442] = x[74]*3.0;
  dxdotdp[452] = x[87]*3.0;
  ...
  dxdotdp[272] = -x[272]*dwdp[21];
  dxdotdp[279] = x[272]*3.0-x[279]*3.0;
  dxdotdp[280] = x[279]*3.0-x[280]*3.0;
  dxdotdp[281] = x[280]*3.0-x[281]*3.0;
  dxdotdp[282] = -x[282]*dwdp[21];
  dxdotdp[289] = x[282]*3.0-x[289]*3.0;
  dxdotdp[290] = x[289]*3.0-x[290]*3.0;
  dxdotdp[291] = x[290]*3.0-x[291]*3.0;
  dxdotdp[292] = -x[292]*dwdp[21];
  dxdotdp[299] = x[292]*3.0-x[299]*3.0;
  dxdotdp[300] = x[299]*3.0-x[300]*3.0;
  dxdotdp[301] = x[300]*3.0-x[301]*3.0;
  dxdotdp[302] = -x[302]*dwdp[21];
  dxdotdp[309] = x[302]*3.0-x[309]*3.0;
