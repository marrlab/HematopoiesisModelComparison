...
void dxdotdp_model_A_3(realtype *dxdotdp, const realtype t, const realtype *x, const realtype *p, const realtype *k, const realtype *h, const int ip, const realtype *w, const realtype *dwdp) {
switch (ip) {
  case 7: {
  ...
  dxdotdp[168] = x[89]*3.0;
  dxdotdp[175] = x[102]*3.0;
  dxdotdp[182] = x[115]*3.0;
  dxdotdp[189] = x[128]*3.0;
  dxdotdp[196] = x[141]*3.0;
  dxdotdp[203] = x[154]*3.0;
  ...
  dxdotdp[210] = x[79]*3.0;
  dxdotdp[223] = x[92]*3.0;
  dxdotdp[236] = x[105]*3.0;
  dxdotdp[249] = x[118]*3.0;
  dxdotdp[262] = x[131]*3.0;
  dxdotdp[275] = x[144]*3.0;
  dxdotdp[288] = x[157]*3.0;
  ...
  case 19: {
  dxdotdp[210] = -x[210]*dwdp[25];
  dxdotdp[220] = x[210]*3.0-x[220]*3.0;
  dxdotdp[221] = x[220]*3.0-x[221]*3.0;
  dxdotdp[222] = x[221]*3.0-x[222]*3.0;
  dxdotdp[223] = -x[223]*dwdp[25];
  dxdotdp[233] = x[223]*3.0-x[233]*3.0;
  dxdotdp[234] = x[233]*3.0-x[234]*3.0;
  dxdotdp[235] = x[234]*3.0-x[235]*3.0;
  dxdotdp[236] = -x[236]*dwdp[25];
  dxdotdp[246] = x[236]*3.0-x[246]*3.0;
  dxdotdp[247] = x[246]*3.0-x[247]*3.0;
  dxdotdp[248] = x[247]*3.0-x[248]*3.0;
  dxdotdp[249] = -x[249]*dwdp[25];
  dxdotdp[259] = x[249]*3.0-x[259]*3.0;
  dxdotdp[260] = x[259]*3.0-x[260]*3.0;
  dxdotdp[261] = x[260]*3.0-x[261]*3.0;
  dxdotdp[262] = -x[262]*dwdp[25];
  dxdotdp[272] = x[262]*3.0-x[272]*3.0;
  dxdotdp[273] = x[272]*3.0-x[273]*3.0;
  dxdotdp[274] = x[273]*3.0-x[274]*3.0;
  dxdotdp[275] = -x[275]*dwdp[25];
  dxdotdp[285] = x[275]*3.0-x[285]*3.0;
  dxdotdp[286] = x[285]*3.0-x[286]*3.0;
  dxdotdp[287] = x[286]*3.0-x[287]*3.0;
  dxdotdp[288] = -x[288]*dwdp[25];
  dxdotdp[298] = x[288]*3.0-x[298]*3.0;
