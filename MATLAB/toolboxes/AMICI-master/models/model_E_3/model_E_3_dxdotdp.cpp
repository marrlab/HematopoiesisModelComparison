...
void dxdotdp_model_E_3(realtype *dxdotdp, const realtype t, const realtype *x, const realtype *p, const realtype *k, const realtype *h, const int ip, const realtype *w, const realtype *dwdp) {
switch (ip) {
  case 7: {
  ...
  dxdotdp[91] = x[6]*3.0;
  dxdotdp[107] = x[19]*3.0;
  dxdotdp[123] = x[32]*3.0;
  dxdotdp[139] = x[45]*3.0;
  dxdotdp[155] = x[58]*3.0;
  dxdotdp[171] = x[71]*3.0;
  dxdotdp[187] = x[84]*3.0;
  ...
  dxdotdp[434] = x[9]*3.0;
  dxdotdp[444] = x[22]*3.0;
  dxdotdp[454] = x[35]*3.0;
  dxdotdp[464] = x[48]*3.0;
  dxdotdp[474] = x[61]*3.0;
  dxdotdp[484] = x[74]*3.0;
  dxdotdp[494] = x[87]*3.0;
  ...
  dxdotdp[187] = -x[187]*dwdp[13];
  dxdotdp[197] = x[187]*3.0-x[197]*3.0;
  dxdotdp[198] = x[197]*3.0-x[198]*3.0;
  dxdotdp[199] = x[198]*3.0-x[199]*3.0;
  dxdotdp[434] = x[103]*3.0;
  dxdotdp[444] = x[119]*3.0;
  dxdotdp[454] = x[135]*3.0;
  dxdotdp[464] = x[151]*3.0;
  dxdotdp[474] = x[167]*3.0;
  dxdotdp[484] = x[183]*3.0;
  dxdotdp[494] = x[199]*3.0;
  ...
  case 19: {
  dxdotdp[273] = -x[273]*dwdp[25];
  dxdotdp[283] = x[273]*3.0-x[283]*3.0;
  dxdotdp[284] = x[283]*3.0-x[284]*3.0;
  dxdotdp[285] = x[284]*3.0-x[285]*3.0;
  dxdotdp[286] = -x[286]*dwdp[25];
  dxdotdp[296] = x[286]*3.0-x[296]*3.0;
  dxdotdp[297] = x[296]*3.0-x[297]*3.0;
  dxdotdp[298] = x[297]*3.0-x[298]*3.0;
  dxdotdp[299] = -x[299]*dwdp[25];
  dxdotdp[309] = x[299]*3.0-x[309]*3.0;
  dxdotdp[310] = x[309]*3.0-x[310]*3.0;
  dxdotdp[311] = x[310]*3.0-x[311]*3.0;
  dxdotdp[312] = -x[312]*dwdp[25];
  dxdotdp[322] = x[312]*3.0-x[322]*3.0;
  dxdotdp[323] = x[322]*3.0-x[323]*3.0;
  dxdotdp[324] = x[323]*3.0-x[324]*3.0;
  dxdotdp[325] = -x[325]*dwdp[25];
  dxdotdp[335] = x[325]*3.0-x[335]*3.0;
  dxdotdp[336] = x[335]*3.0-x[336]*3.0;
  dxdotdp[337] = x[336]*3.0-x[337]*3.0;
  dxdotdp[338] = -dwdp[25]*x[338];
  dxdotdp[348] = x[338]*3.0-x[348]*3.0;
  dxdotdp[349] = x[348]*3.0-x[349]*3.0;
  dxdotdp[350] = x[349]*3.0-x[350]*3.0;
  dxdotdp[351] = -dwdp[25]*x[351];
  dxdotdp[361] = x[351]*3.0-x[361]*3.0;
