...
void dxdotdp_model_D_3(realtype *dxdotdp, const realtype t, const realtype *x, const realtype *p, const realtype *k, const realtype *h, const int ip, const realtype *w, const realtype *dwdp) {
switch (ip) {
  case 7: {
  ...
  dxdotdp[462] = x[9]*3.0;
  dxdotdp[469] = x[22]*3.0;
  dxdotdp[476] = x[35]*3.0;
  dxdotdp[483] = x[48]*3.0;
  dxdotdp[490] = x[61]*3.0;
  dxdotdp[497] = x[74]*3.0;
  dxdotdp[504] = x[87]*3.0;
  ...
  dxdotdp[244] = x[110]*3.0;
  dxdotdp[257] = x[123]*3.0;
  dxdotdp[270] = x[136]*3.0;
  dxdotdp[283] = x[149]*3.0;
  dxdotdp[296] = x[162]*3.0;
  dxdotdp[309] = x[175]*3.0;
