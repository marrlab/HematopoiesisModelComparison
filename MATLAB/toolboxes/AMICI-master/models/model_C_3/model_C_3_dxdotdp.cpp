...
void dxdotdp_model_C_3(realtype *dxdotdp, const realtype t, const realtype *x, const realtype *p, const realtype *k, const realtype *h, const int ip, const realtype *w, const realtype *dwdp) {
switch (ip) {
  case 7: {
  ...
  dxdotdp[483] = x[9]*3.0;
  dxdotdp[490] = x[22]*3.0;
  dxdotdp[497] = x[35]*3.0;
  dxdotdp[504] = x[48]*3.0;
  dxdotdp[511] = x[61]*3.0;
  dxdotdp[518] = x[74]*3.0;
  dxdotdp[525] = x[87]*3.0;
  ...
  dxdotdp[265] = x[110]*3.0;
  dxdotdp[278] = x[123]*3.0;
  dxdotdp[291] = x[136]*3.0;
  dxdotdp[304] = x[149]*3.0;
  dxdotdp[317] = x[162]*3.0;
  dxdotdp[330] = x[175]*3.0;
