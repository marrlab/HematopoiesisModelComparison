...
%%% (1) MODEL: 
modelname = "hematopoiesis_model_A";
% modelname = 'hematopoiesis_model_A';
% modelname = 'hematopoiesis_model_B';
% modelname = 'hematopoiesis_model_C';
% modelname = 'hematopoiesis_model_D';
% modelname = 'hematopoiesis_model_E';
% modelname = 'hematopoiesis_model_F';
% modelname = 'hematopoiesis_model_G';
% modelname = 'hematopoiesis_model_H';
% modelname = 'hematopoiesis_model_I';
% modelname = 'hematopoiesis_model_J';
...
opts.maxLietime = 8000;    % max. time allowed for calculating 1 Lie derivative.
