...
%     n_iS = 3;
    ...
    bool_healthy_individuals_only = true;%false;
    
    for iS_id = 1:length(n_iS)
        if length(n_iS)>1
            I_names = {'353_1','345_1','559_1','560_1','482_1','522_1'};
            r_path = ['results_hierarchy_comparison_BIC_7divs_',num2str(n_iS(iS_id)),'iS_HO_LogNormal_fit_iC'];
            TH=length(I_names);
            add_str = '_rep_sep';
        else
            ...
            if bool_fit_repetitions_seperately==true
                if bool_healthy_individuals_only==true
                    I_names = {'439_1','547_1','482_1','508_1','522_1','552_1','519_1','370_1','353_1','345_1','311_1','380_1','391_1','391_2','312_1','312_2','560_1','559_1','561_1','348_1','500_1'};
                    TH=length(I_names);
                else
                    I_names = {'439_1','547_1','482_1','508_1','522_1','552_1','519_1','370_1','353_1','345_1','311_1','380_1','391_1','391_2','312_1','312_2','560_1','559_1','561_1','348_1','500_1','135_1','140_1','279_1','326_1','354_1','360_1','373_1','377_1'};%'227_1'};
                    TH=21;
                end
                add_str = '_rep_sep';
            else
        ...
        Time_mat = zeros(length(M_names),length(I_names));
        ...
        for model_id=1:length(M_names)
            ...
            for indi_id=1:length(I_names)
                clearvars -except group_str_all model_id indi_id M_names I_names AIC_corrected_mat AIC_mat BIC_mat LOGL_mat Time_mat AIC_corrected_all_mat AIC_all_mat BIC_all_mat LOGL_all_mat MS_num_mat r_path c_path TH add_str iS_id n_iS
                if indi_id<=TH
                    group_str='healthy';
                else
                    group_str='MDS';
                ...
                load(['WS_',group_str,'_individual_',I_names{indi_id},'.mat'],'parameters','opt','options_par','time_in_s')
                cd(c_path);
                opt.c_path = c_path;
                opt.pythonDataVisualization_path = [r_path,'/'];
        ...
        clearvars -except AIC_corrected_mat AIC_mat BIC_mat LOGL_mat Time_mat AIC_corrected_all_mat AIC_all_mat BIC_all_mat LOGL_all_mat MS_num_mat r_path c_path add_str n_iS iS_id M_names
        cd(r_path)
